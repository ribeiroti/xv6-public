  ...
  1c:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "write %d\n", i);
  8e:	6a 01                	push   $0x1
  90:	e8 4b 04 00 00       	call   4e0 <printf>
  path[8] += i;
  ...
  aa:	50                   	push   %eax
  ab:	e8 22 03 00 00       	call   3d2 <open>
...
//    printf(fd, "%d\n", i);
  ...
  c0:	56                   	push   %esi
  c1:	57                   	push   %edi
  c2:	e8 eb 02 00 00       	call   3b2 <write>
  for(i = 0; i < 20; i++)
  ...
  d2:	57                   	push   %edi
  d3:	e8 e2 02 00 00       	call   3ba <close>

  printf(1, "read\n");
  d8:	58                   	pop    %eax
  d9:	5a                   	pop    %edx
  da:	68 55 08 00 00       	push   $0x855
  df:	6a 01                	push   $0x1
  ...
  f6:	e8 d7 02 00 00       	call   3d2 <open>
