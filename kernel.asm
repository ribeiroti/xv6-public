...
801002ef:	e8 6c 42 00 00       	call   80104560 <release>
        ilock(ip);
...
8010034d:	e8 0e 42 00 00       	call   80104560 <release>
  ilock(ip);
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 fb 7b 10 80 	movl   $0x80107bfb,(%esp)
...
80100524:	e8 37 41 00 00       	call   80104660 <memmove>
...
80100541:	e8 6a 40 00 00       	call   801045b0 <memset>
...
8010071f:	e8 3c 3e 00 00       	call   80104560 <release>
...
801007f0:	e8 ab 3c 00 00       	call   801044a0 <acquire>
...
80100823:	e8 78 3c 00 00       	call   801044a0 <acquire>
  while((c = getc()) >= 0){
...
80100888:	e8 d3 3c 00 00       	call   80104560 <release>
  if(doprocdump) {
...
801009d0:	e8 8b 39 00 00       	call   80104360 <initlock>
...
80100c39:	e8 92 3b 00 00       	call   801047d0 <strlen>
...
80100c4c:	e8 7f 3b 00 00       	call   801047d0 <strlen>
...
80100d0a:	e8 81 3a 00 00       	call   80104790 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d70:	e8 eb 35 00 00       	call   80104360 <initlock>
}
...
80100d91:	e8 0a 37 00 00       	call   801044a0 <acquire>
...
80100dc1:	e8 9a 37 00 00       	call   80104560 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dda:	e8 81 37 00 00       	call   80104560 <release>
}
...
80100dff:	e8 9c 36 00 00       	call   801044a0 <acquire>
  if(f->ref < 1)
...
80100e1c:	e8 3f 37 00 00       	call   80104560 <release>
  return f;
}
...
80100e51:	e8 4a 36 00 00       	call   801044a0 <acquire>
  if(f->ref < 1)
...
80100e7b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e7c:	e9 df 36 00 00       	jmp    80104560 <release>
...
80100ea5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100ea8:	e8 b3 36 00 00       	call   80104560 <release>
  if(ff.type == FD_PIPE)
...
801011f5:	e8 b6 33 00 00       	call   801045b0 <memset>
  log_write(bp);
...
8010123a:	e8 61 32 00 00       	call   801044a0 <acquire>
...
801012ca:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012cd:	e8 8e 32 00 00       	call   80104560 <release>
      return ip;
...
801013f1:	e8 6a 32 00 00       	call   80104660 <memmove>
  brelse(bp);
...
801014a6:	e8 b5 2e 00 00       	call   80104360 <initlock>
...
801014bf:	e8 6c 2d 00 00       	call   80104230 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010159e:	e8 0d 30 00 00       	call   801045b0 <memset>
      dip->type = type;
...
80101641:	e8 1a 30 00 00       	call   80104660 <memmove>
  log_write(bp);
...
8010166f:	e8 2c 2e 00 00       	call   801044a0 <acquire>
  ip->ref++;
80101674:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101678:	c7 04 24 a0 13 11 80 	movl   $0x801113a0,(%esp)
8010167f:	e8 dc 2e 00 00       	call   80104560 <release>
}
...
801016b2:	e8 b9 2b 00 00       	call   80104270 <acquiresleep>
  if(ip->valid == 0){
...
80101728:	e8 33 2f 00 00       	call   80104660 <memmove>
    brelse(bp);
...
80101783:	e8 88 2b 00 00       	call   80104310 <holdingsleep>
...
8010179e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010179f:	e9 2c 2b 00 00       	jmp    801042d0 <releasesleep>
    panic("iunlock");
...
801017d0:	e8 9b 2a 00 00       	call   80104270 <acquiresleep>
...
801017ea:	e8 e1 2a 00 00       	call   801042d0 <releasesleep>
  acquire(&icache.lock);
801017ef:	c7 04 24 a0 13 11 80 	movl   $0x801113a0,(%esp)
801017f6:	e8 a5 2c 00 00       	call   801044a0 <acquire>
  ip->ref--;
...
8010180f:	5d                   	pop    %ebp
  release(&icache.lock);
80101810:	e9 4b 2d 00 00       	jmp    80104560 <release>
80101815:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101818:	83 ec 0c             	sub    $0xc,%esp
8010181b:	68 a0 13 11 80       	push   $0x801113a0
80101820:	e8 7b 2c 00 00       	call   801044a0 <acquire>
    int r = ip->ref;
80101825:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101828:	c7 04 24 a0 13 11 80 	movl   $0x801113a0,(%esp)
8010182f:	e8 2c 2d 00 00       	call   80104560 <release>
    if(r == 1){
...
80101a15:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a17:	e8 44 2c 00 00       	call   80104660 <memmove>
    brelse(bp);
...
80101b13:	e8 48 2b 00 00       	call   80104660 <memmove>
    log_write(bp);
...
80101bae:	e8 1d 2b 00 00       	call   801046d0 <strncmp>
}
80101bb3:	c9                   	leave  
80101bb4:	c3                   	ret    
...
80101c0d:	e8 be 2a 00 00       	call   801046d0 <strncmp>
      continue;
...
80101c99:	e8 02 28 00 00       	call   801044a0 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 a0 13 11 80 	movl   $0x801113a0,(%esp)
80101ca9:	e8 b2 28 00 00       	call   80104560 <release>
...
80101d05:	e8 56 29 00 00       	call   80104660 <memmove>
    path++;
...
80101d98:	e8 c3 28 00 00       	call   80104660 <memmove>
    name[len] = 0;
...
80101e8d:	e8 9e 28 00 00       	call   80104730 <strncpy>
  de.inum = inum;
...
80101ed8:	68 e2 79 10 80       	push   $0x801079e2
...
80102020:	e8 3b 23 00 00       	call   80104360 <initlock>
...
8010209e:	e8 fd 23 00 00       	call   801044a0 <acquire>
...
8010211f:	e8 3c 24 00 00       	call   80104560 <release>
...
8010213e:	e8 cd 21 00 00       	call   80104310 <holdingsleep>
...
80102178:	e8 23 23 00 00       	call   801044a0 <acquire>
...
801021e5:	c9                   	leave  
  release(&idelock);
801021e6:	e9 75 23 00 00       	jmp    80104560 <release>
801021eb:	90                   	nop
...
80102352:	e8 59 22 00 00       	call   801045b0 <memset>
...
8010238a:	c9                   	leave  
    release(&kmem.lock);
8010238b:	e9 d0 21 00 00       	jmp    80104560 <release>
    acquire(&kmem.lock);
80102390:	83 ec 0c             	sub    $0xc,%esp
80102393:	68 00 30 11 80       	push   $0x80113000
80102398:	e8 03 21 00 00       	call   801044a0 <acquire>
...
80102415:	e8 46 1f 00 00       	call   80104360 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102503:	e8 98 1f 00 00       	call   801044a0 <acquire>
  r = kmem.freelist;
...
80102531:	e8 2a 20 00 00       	call   80104560 <release>
  return (char*)r;
...
80102947:	e8 b4 1c 00 00       	call   80104600 <memcmp>
...
80102bbb:	e8 e0 18 00 00       	call   801044a0 <acquire>
...
80102c2e:	e8 6d 18 00 00       	call   801044a0 <acquire>
  log.outstanding -= 1;
...
80102c6c:	e8 ef 18 00 00       	call   80104560 <release>
}
...
80102cc6:	e8 95 19 00 00       	call   80104660 <memmove>
...
80102d0f:	e8 8c 17 00 00       	call   801044a0 <acquire>
    wakeup(&log);
...
80102d31:	e8 2a 18 00 00       	call   80104560 <release>
...
80102d5c:	e8 ff 17 00 00       	call   80104560 <release>
...
80102e0c:	c9                   	leave  
  release(&log.lock);
80102e0d:	e9 4e 17 00 00       	jmp    80104560 <release>
...
80102e72:	e8 09 2a 00 00       	call   80105880 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 d5 3a 00 00       	call   80106970 <switchkvm>
  seginit();
80102e9b:	e8 40 3a 00 00       	call   801068e0 <seginit>
  lapicinit();
...
80102ed1:	e8 6a 3f 00 00       	call   80106e40 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 fb 39 00 00       	call   801068e0 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 b7 2c 00 00       	call   80105bb0 <uartinit>
  pinit();         // process table
80102ef9:	e8 22 08 00 00       	call   80103720 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 fd 28 00 00       	call   80105800 <tvinit>
  binit();         // buffer cache
...
80102f24:	e8 37 17 00 00       	call   80104660 <memmove>
...
80103004:	e8 f7 15 00 00       	call   80104600 <memcmp>
...
801030c2:	e8 39 15 00 00       	call   80104600 <memcmp>
...
801031fb:	68 3d 77 10 80       	push   $0x8010773d
80103200:	e8 8b d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
80103205:	83 ec 0c             	sub    $0xc,%esp
80103208:	68 5c 77 10 80       	push   $0x8010775c
...
801032f8:	00 00 00 
  initlock(&p->lock, "pipe");
801032fb:	68 90 77 10 80       	push   $0x80107790
80103300:	50                   	push   %eax
80103301:	e8 5a 10 00 00       	call   80104360 <initlock>
  (*f0)->type = FD_PIPE;
...
8010335f:	e8 3c 11 00 00       	call   801044a0 <acquire>
  if(writable){
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 b7 11 00 00       	jmp    80104560 <release>
...
801033d4:	e8 87 11 00 00       	call   80104560 <release>
    kfree((char*)p);
...
801033fd:	e8 9e 10 00 00       	call   801044a0 <acquire>
  for(i = 0; i < n; i++){
...
80103494:	e8 c7 10 00 00       	call   80104560 <release>
        return -1;
...
801034eb:	e8 70 10 00 00       	call   80104560 <release>
  return n;
...
80103510:	e8 8b 0f 00 00       	call   801044a0 <acquire>
...
8010357e:	e8 dd 0f 00 00       	call   80104560 <release>
      return -1;
...
801035df:	e8 7c 0f 00 00       	call   80104560 <release>
  return i;
...
80103611:	e8 8a 0e 00 00       	call   801044a0 <acquire>
...
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 09 0f 00 00       	call   80104560 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 ee 57 10 80 	movl   $0x801057ee,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 25 0f 00 00       	call   801045b0 <memset>
...
801036aa:	e8 b1 0e 00 00       	call   80104560 <release>
}
...
801036db:	e8 80 0e 00 00       	call   80104560 <release>
...
80103726:	68 95 77 10 80       	push   $0x80107795
8010372b:	68 00 32 11 80       	push   $0x80113200
80103730:	e8 2b 0c 00 00       	call   80104360 <initlock>
}
...
8010376a:	68 9c 77 10 80       	push   $0x8010779c
...
80103782:	68 84 78 10 80       	push   $0x80107884
...
801037b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037b7:	e8 14 0c 00 00       	call   801043d0 <pushcli>
  c = mycpu();
801037bc:	e8 7f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037c7:	e8 44 0c 00 00       	call   80104410 <popcli>
}
...
801037f3:	e8 c8 35 00 00       	call   80106dc0 <setupkvm>
...
80103811:	e8 8a 32 00 00       	call   80106aa0 <inituvm>
...
80103826:	e8 85 0d 00 00       	call   801045b0 <memset>
...
8010387f:	68 c5 77 10 80       	push   $0x801077c5
80103884:	50                   	push   %eax
80103885:	e8 06 0f 00 00       	call   80104790 <safestrcpy>
  p->cwd = namei("/");
8010388a:	c7 04 24 ce 77 10 80 	movl   $0x801077ce,(%esp)
...
801038c3:	68 ac 77 10 80       	push   $0x801077ac
...
801038d5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801038d8:	e8 f3 0a 00 00       	call   801043d0 <pushcli>
  c = mycpu();
801038dd:	e8 5e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
801038e2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038e8:	e8 23 0b 00 00       	call   80104410 <popcli>
  if(n > 0){
...
801038fc:	e8 8f 30 00 00       	call   80106990 <switchuvm>
  return 0;
...
8010391a:	e8 c1 32 00 00       	call   80106be0 <allocuvm>
...
8010393a:	e8 d1 33 00 00       	call   80106d10 <deallocuvm>
...
80103956:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103959:	e8 72 0a 00 00       	call   801043d0 <pushcli>
  c = mycpu();
8010395e:	e8 dd fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103963:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103969:	e8 a2 0a 00 00       	call   80104410 <popcli>
  if((np = allocproc()) == 0){
...
80103988:	e8 03 35 00 00       	call   80106e90 <copyuvm>
...
80103af6:	e8 f5 36 00 00       	call   801071f0 <random_at_most>
...
80103b21:	e8 7a 09 00 00       	call   801044a0 <acquire>
      d++;
...
80103b5c:	e8 8f 36 00 00       	call   801071f0 <random_at_most>
...
80103bdd:	68 ac 78 10 80       	push   $0x801078ac
...
80103bfa:	e8 91 2d 00 00       	call   80106990 <switchuvm>
...
80103c0a:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
          swtch(&(c->scheduler), p->context);
80103c11:	e8 d5 0b 00 00       	call   801047eb <swtch>
          switchkvm();
80103c16:	e8 55 2d 00 00       	call   80106970 <switchkvm>
          c->proc = 0;
...
80103c30:	e8 2b 09 00 00       	call   80104560 <release>
      sti();
...
80103cc3:	e8 23 0b 00 00       	call   801047eb <swtch>
  mycpu()->intena = intena;
...
80103d26:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d29:	e8 a2 06 00 00       	call   801043d0 <pushcli>
  c = mycpu();
80103d2e:	e8 0d fa ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d33:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d39:	e8 d2 06 00 00       	call   80104410 <popcli>
  if(curproc == initproc)
...
80103d92:	e8 09 07 00 00       	call   801044a0 <acquire>
...
80103e3a:	68 10 78 10 80       	push   $0x80107810
...
80103e5c:	e8 3f 06 00 00       	call   801044a0 <acquire>
  pushcli();
80103e61:	e8 6a 05 00 00       	call   801043d0 <pushcli>
  c = mycpu();
80103e66:	e8 d5 f8 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103e6b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e71:	e8 9a 05 00 00       	call   80104410 <popcli>
...
80103e89:	e8 d2 06 00 00       	call   80104560 <release>
}
...
80103eac:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103eaf:	e8 1c 05 00 00       	call   801043d0 <pushcli>
  c = mycpu();
80103eb4:	e8 87 f8 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103eb9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ebf:	e8 4c 05 00 00       	call   80104410 <popcli>
  if(p == 0)
...
80103ee0:	e8 bb 05 00 00       	call   801044a0 <acquire>
    release(lk);
80103ee5:	89 34 24             	mov    %esi,(%esp)
80103ee8:	e8 73 06 00 00       	call   80104560 <release>
  p->chan = chan;
...
80103f0a:	e8 51 06 00 00       	call   80104560 <release>
    acquire(lk);
...
80103f1b:	5d                   	pop    %ebp
    acquire(lk);
80103f1c:	e9 7f 05 00 00       	jmp    801044a0 <acquire>
...
80103f49:	68 2f 78 10 80       	push   $0x8010782f
80103f4e:	e8 3d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f53:	83 ec 0c             	sub    $0xc,%esp
80103f56:	68 29 78 10 80       	push   $0x80107829
...
80103ff2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ff9:	e8 42 2d 00 00       	call   80106d40 <freevm>
        release(&ptable.lock);
...
8010401e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104025:	e8 36 05 00 00       	call   80104560 <release>
        return pid;
...
80104043:	e8 18 05 00 00       	call   80104560 <release>
      return -1;
...
8010405f:	e8 3c 04 00 00       	call   801044a0 <acquire>
...
801040a0:	c9                   	leave  
  release(&ptable.lock);
801040a1:	e9 ba 04 00 00       	jmp    80104560 <release>
...
801040bf:	e8 dc 03 00 00       	call   801044a0 <acquire>
...
801040fb:	e8 60 04 00 00       	call   80104560 <release>
      return 0;
...
80104118:	e8 43 04 00 00       	call   80104560 <release>
  return -1;
...
8010414d:	68 fb 7b 10 80       	push   $0x80107bfb
...
80104163:	0f 83 b7 00 00 00    	jae    80104220 <procdump+0xf0>
      if(p->state == UNUSED)
...
80104170:	83 f8 05             	cmp    $0x5,%eax
        state = "???";
80104173:	bf 40 78 10 80       	mov    $0x80107840,%edi
      if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104178:	77 11                	ja     8010418b <procdump+0x5b>
8010417a:	8b 3c 85 ec 78 10 80 	mov    -0x7fef8714(,%eax,4),%edi
        state = "???";
80104181:	b8 40 78 10 80       	mov    $0x80107840,%eax
...
80104191:	68 44 78 10 80       	push   $0x80107844
80104196:	e8 35 06 00 00       	call   801047d0 <strlen>
8010419b:	83 c4 0c             	add    $0xc,%esp
8010419e:	50                   	push   %eax
8010419f:	68 44 78 10 80       	push   $0x80107844
801041a4:	56                   	push   %esi
801041a5:	e8 26 05 00 00       	call   801046d0 <strncmp>
...
801041bc:	68 4c 78 10 80       	push   $0x8010784c
...
801041d9:	8d 7d c0             	lea    -0x40(%ebp),%edi
801041dc:	50                   	push   %eax
801041dd:	8b 43 1c             	mov    0x1c(%ebx),%eax
801041e0:	8b 40 0c             	mov    0xc(%eax),%eax
801041e3:	83 c0 08             	add    $0x8,%eax
801041e6:	50                   	push   %eax
801041e7:	e8 94 01 00 00       	call   80104380 <getcallerpcs>
801041ec:	83 c4 10             	add    $0x10,%esp
801041ef:	90                   	nop
        for(int i=0; i<10 && pc[i] != 0; i++)
801041f0:	8b 17                	mov    (%edi),%edx
801041f2:	85 d2                	test   %edx,%edx
801041f4:	0f 84 50 ff ff ff    	je     8010414a <procdump+0x1a>
          cprintf(" %p", pc[i]);
801041fa:	83 ec 08             	sub    $0x8,%esp
801041fd:	83 c7 04             	add    $0x4,%edi
80104200:	52                   	push   %edx
80104201:	68 81 72 10 80       	push   $0x80107281
80104206:	e8 55 c4 ff ff       	call   80100660 <cprintf>
        for(int i=0; i<10 && pc[i] != 0; i++)
8010420b:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010420e:	83 c4 10             	add    $0x10,%esp
80104211:	39 f8                	cmp    %edi,%eax
80104213:	75 db                	jne    801041f0 <procdump+0xc0>
80104215:	e9 30 ff ff ff       	jmp    8010414a <procdump+0x1a>
...
8010423a:	68 04 79 10 80       	push   $0x80107904
8010423f:	8d 43 04             	lea    0x4(%ebx),%eax
80104242:	50                   	push   %eax
80104243:	e8 18 01 00 00       	call   80104360 <initlock>
  lk->name = name;
...
8010427f:	e8 1c 02 00 00       	call   801044a0 <acquire>
  while (lk->locked) {
...
80104295:	e8 06 fc ff ff       	call   80103ea0 <sleep>
  while (lk->locked) {
...
801042a3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042a9:	e8 02 f5 ff ff       	call   801037b0 <myproc>
...
801042f4:	e8 57 fd ff ff       	call   80104050 <wakeup>
  release(&lk->lk);
...
80104316:	31 ff                	xor    %edi,%edi
80104318:	83 ec 18             	sub    $0x18,%esp
8010431b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
8010431e:	8d 73 04             	lea    0x4(%ebx),%esi
80104321:	56                   	push   %esi
80104322:	e8 79 01 00 00       	call   801044a0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104327:	8b 03                	mov    (%ebx),%eax
80104329:	83 c4 10             	add    $0x10,%esp
8010432c:	85 c0                	test   %eax,%eax
8010432e:	74 13                	je     80104343 <holdingsleep+0x33>
80104330:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104333:	e8 78 f4 ff ff       	call   801037b0 <myproc>
80104338:	39 58 10             	cmp    %ebx,0x10(%eax)
8010433b:	0f 94 c0             	sete   %al
8010433e:	0f b6 c0             	movzbl %al,%eax
80104341:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
80104343:	83 ec 0c             	sub    $0xc,%esp
80104346:	56                   	push   %esi
80104347:	e8 14 02 00 00       	call   80104560 <release>
  return r;
}
8010434c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010434f:	89 f8                	mov    %edi,%eax
80104351:	5b                   	pop    %ebx
80104352:	5e                   	pop    %esi
80104353:	5f                   	pop    %edi
80104354:	5d                   	pop    %ebp
...
801043ef:	e8 4c f3 ff ff       	call   80103740 <mycpu>
801043f4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801043fa:	e8 41 f3 ff ff       	call   80103740 <mycpu>
...
80104455:	68 0f 79 10 80       	push   $0x8010790f
8010445a:	e8 31 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010445f:	83 ec 0c             	sub    $0xc,%esp
80104462:	68 26 79 10 80       	push   $0x80107926
...
80104478:	31 db                	xor    %ebx,%ebx
  pushcli();
8010447a:	e8 51 ff ff ff       	call   801043d0 <pushcli>
...
80104488:	e8 b3 f2 ff ff       	call   80103740 <mycpu>
8010448d:	39 c3                	cmp    %eax,%ebx
8010448f:	0f 94 c3             	sete   %bl
80104492:	0f b6 db             	movzbl %bl,%ebx
  popcli();
80104495:	e8 76 ff ff ff       	call   80104410 <popcli>
}
...
801044a5:	e8 26 ff ff ff       	call   801043d0 <pushcli>
  if(holding(lk))
801044aa:	8b 5d 08             	mov    0x8(%ebp),%ebx
801044ad:	83 ec 0c             	sub    $0xc,%esp
801044b0:	53                   	push   %ebx
801044b1:	e8 ba ff ff ff       	call   80104470 <holding>
...
801044e4:	e8 57 f2 ff ff       	call   80103740 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801044e9:	8d 53 0c             	lea    0xc(%ebx),%edx
  lk->cpu = mycpu();
801044ec:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
801044ef:	89 e8                	mov    %ebp,%eax
801044f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801044f8:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801044fe:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80104504:	77 1a                	ja     80104520 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
80104506:	8b 48 04             	mov    0x4(%eax),%ecx
80104509:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
  for(i = 0; i < 10; i++){
8010450c:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
8010450f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104511:	83 fe 0a             	cmp    $0xa,%esi
...
80104520:	8d 04 b2             	lea    (%edx,%esi,4),%eax
80104523:	83 c2 28             	add    $0x28,%edx
...
80104547:	68 2d 79 10 80       	push   $0x8010792d
...
8010456b:	e8 00 ff ff ff       	call   80104470 <holding>
...
8010459c:	68 35 79 10 80       	push   $0x80107935
...
80104672:	8d 0c 33             	lea    (%ebx,%esi,1),%ecx
...
801046e3:	0f b6 01             	movzbl (%ecx),%eax
801046e6:	0f b6 1e             	movzbl (%esi),%ebx
801046e9:	84 c0                	test   %al,%al
801046eb:	74 37                	je     80104724 <strncmp+0x54>
801046ed:	38 c3                	cmp    %al,%bl
...
801046f8:	0f b6 01             	movzbl (%ecx),%eax
801046fb:	84 c0                	test   %al,%al
801046fd:	74 21                	je     80104720 <strncmp+0x50>
801046ff:	0f b6 1a             	movzbl (%edx),%ebx
80104702:	89 d6                	mov    %edx,%esi
80104704:	38 d8                	cmp    %bl,%al
80104706:	75 1c                	jne    80104724 <strncmp+0x54>
    n--, p++, q++;
80104708:	8d 56 01             	lea    0x1(%esi),%edx
8010470b:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010470e:	39 fa                	cmp    %edi,%edx
...
80104807:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010480a:	e8 a1 ef ff ff       	call   801037b0 <myproc>
...
80104847:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010484a:	e8 61 ef ff ff       	call   801037b0 <myproc>
...
80104865:	eb 39                	jmp    801048a0 <fetchstr+0x60>
...
801048a0:	31 c0                	xor    %eax,%eax
      return s - *pp;
801048a2:	eb dd                	jmp    80104881 <fetchstr+0x41>
...
801048b5:	e8 f6 ee ff ff       	call   801037b0 <myproc>
...
801048c3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801048c6:	e8 e5 ee ff ff       	call   801037b0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104908:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010490b:	e8 a0 ee ff ff       	call   801037b0 <myproc>
...
80104982:	e8 b9 fe ff ff       	call   80104840 <fetchstr>
...
801049a4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801049a7:	e8 04 ee ff ff       	call   801037b0 <myproc>
...
801049b7:	83 fa 15             	cmp    $0x15,%edx
801049ba:	77 1c                	ja     801049d8 <syscall+0x38>
801049bc:	8b 14 85 60 79 10 80 	mov    -0x7fef86a0(,%eax,4),%edx
801049c3:	85 d2                	test   %edx,%edx
801049c5:	74 11                	je     801049d8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
801049c7:	ff d2                	call   *%edx
801049c9:	8b 53 18             	mov    0x18(%ebx),%edx
801049cc:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
801049e0:	68 3d 79 10 80       	push   $0x8010793d
...
80104a17:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a1a:	e8 f1 d4 ff ff       	call   80101f10 <nameiparent>
80104a1f:	83 c4 10             	add    $0x10,%esp
80104a22:	85 c0                	test   %eax,%eax
80104a24:	0f 84 46 01 00 00    	je     80104b70 <create+0x170>
    return 0;
  ilock(dp);
80104a2a:	83 ec 0c             	sub    $0xc,%esp
80104a2d:	89 c3                	mov    %eax,%ebx
80104a2f:	50                   	push   %eax
80104a30:	e8 5b cc ff ff       	call   80101690 <ilock>
...
80104a3e:	e8 7d d1 ff ff       	call   80101bc0 <dirlookup>
80104a43:	83 c4 10             	add    $0x10,%esp
80104a46:	85 c0                	test   %eax,%eax
80104a48:	89 c7                	mov    %eax,%edi
80104a4a:	74 34                	je     80104a80 <create+0x80>
    iunlockput(dp);
80104a4c:	83 ec 0c             	sub    $0xc,%esp
80104a4f:	53                   	push   %ebx
80104a50:	e8 cb ce ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104a55:	89 3c 24             	mov    %edi,(%esp)
80104a58:	e8 33 cc ff ff       	call   80101690 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104a5d:	83 c4 10             	add    $0x10,%esp
80104a60:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104a65:	0f 85 95 00 00 00    	jne    80104b00 <create+0x100>
80104a6b:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104a70:	0f 85 8a 00 00 00    	jne    80104b00 <create+0x100>
...
80104a76:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80104a8a:	e8 91 ca ff ff       	call   80101520 <ialloc>
80104a8f:	83 c4 10             	add    $0x10,%esp
80104a92:	85 c0                	test   %eax,%eax
80104a94:	89 c7                	mov    %eax,%edi
80104a96:	0f 84 e8 00 00 00    	je     80104b84 <create+0x184>
  ilock(ip);
80104a9c:	83 ec 0c             	sub    $0xc,%esp
80104a9f:	50                   	push   %eax
80104aa0:	e8 eb cb ff ff       	call   80101690 <ilock>
  ip->major = major;
80104aa5:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104aa9:	66 89 47 52          	mov    %ax,0x52(%edi)
  ip->minor = minor;
80104aad:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
...
80104ac1:	e8 1a cb ff ff       	call   801015e0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104ac6:	83 c4 10             	add    $0x10,%esp
80104ac9:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
80104ace:	74 50                	je     80104b20 <create+0x120>
  if(dirlink(dp, name, ip->inum) < 0)
80104ad0:	83 ec 04             	sub    $0x4,%esp
80104ad3:	ff 77 04             	pushl  0x4(%edi)
80104ad6:	56                   	push   %esi
80104ad7:	53                   	push   %ebx
80104ad8:	e8 53 d3 ff ff       	call   80101e30 <dirlink>
80104add:	83 c4 10             	add    $0x10,%esp
80104ae0:	85 c0                	test   %eax,%eax
80104ae2:	0f 88 8f 00 00 00    	js     80104b77 <create+0x177>
  iunlockput(dp);
80104ae8:	83 ec 0c             	sub    $0xc,%esp
80104aeb:	53                   	push   %ebx
80104aec:	e8 2f ce ff ff       	call   80101920 <iunlockput>
  return ip;
...
80104b04:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104b06:	e8 15 ce ff ff       	call   80101920 <iunlockput>
    return 0;
...
80104b29:	e8 b2 ca ff ff       	call   801015e0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b2e:	83 c4 0c             	add    $0xc,%esp
80104b31:	ff 77 04             	pushl  0x4(%edi)
80104b34:	68 d8 79 10 80       	push   $0x801079d8
80104b39:	57                   	push   %edi
80104b3a:	e8 f1 d2 ff ff       	call   80101e30 <dirlink>
80104b3f:	83 c4 10             	add    $0x10,%esp
80104b42:	85 c0                	test   %eax,%eax
80104b44:	78 1c                	js     80104b62 <create+0x162>
80104b46:	83 ec 04             	sub    $0x4,%esp
80104b49:	ff 73 04             	pushl  0x4(%ebx)
80104b4c:	68 d7 79 10 80       	push   $0x801079d7
80104b51:	57                   	push   %edi
80104b52:	e8 d9 d2 ff ff       	call   80101e30 <dirlink>
80104b57:	83 c4 10             	add    $0x10,%esp
80104b5a:	85 c0                	test   %eax,%eax
80104b5c:	0f 89 6e ff ff ff    	jns    80104ad0 <create+0xd0>
      panic("create dots");
80104b62:	83 ec 0c             	sub    $0xc,%esp
80104b65:	68 cb 79 10 80       	push   $0x801079cb
80104b6a:	e8 21 b8 ff ff       	call   80100390 <panic>
80104b6f:	90                   	nop
    return 0;
80104b70:	31 ff                	xor    %edi,%edi
80104b72:	e9 ff fe ff ff       	jmp    80104a76 <create+0x76>
    panic("create: dirlink");
80104b77:	83 ec 0c             	sub    $0xc,%esp
80104b7a:	68 da 79 10 80       	push   $0x801079da
80104b7f:	e8 0c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b84:	83 ec 0c             	sub    $0xc,%esp
80104b87:	68 bc 79 10 80       	push   $0x801079bc
80104b8c:	e8 ff b7 ff ff       	call   80100390 <panic>
80104b91:	eb 0d                	jmp    80104ba0 <argfd.constprop.0>
80104b93:	90                   	nop
80104b94:	90                   	nop
80104b95:	90                   	nop
80104b96:	90                   	nop
...
80104ba5:	89 c3                	mov    %eax,%ebx
  if(argint(n, &fd) < 0)
80104ba7:	8d 45 f4             	lea    -0xc(%ebp),%eax
argfd(int n, int *pfd, struct file **pf)
80104baa:	89 d6                	mov    %edx,%esi
...
80104bbc:	78 2a                	js     80104be8 <argfd.constprop.0+0x48>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104bbe:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104bc2:	77 24                	ja     80104be8 <argfd.constprop.0+0x48>
80104bc4:	e8 e7 eb ff ff       	call   801037b0 <myproc>
80104bc9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104bcc:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104bd0:	85 c0                	test   %eax,%eax
80104bd2:	74 14                	je     80104be8 <argfd.constprop.0+0x48>
  if(pfd)
80104bd4:	85 db                	test   %ebx,%ebx
80104bd6:	74 02                	je     80104bda <argfd.constprop.0+0x3a>
    *pfd = fd;
80104bd8:	89 13                	mov    %edx,(%ebx)
    *pf = f;
80104bda:	89 06                	mov    %eax,(%esi)
  return 0;
80104bdc:	31 c0                	xor    %eax,%eax
}
...
80104bed:	eb ef                	jmp    80104bde <argfd.constprop.0+0x3e>
80104bef:	90                   	nop
...
80104bfa:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104bfd:	e8 9e ff ff ff       	call   80104ba0 <argfd.constprop.0>
80104c02:	85 c0                	test   %eax,%eax
80104c04:	78 42                	js     80104c48 <sys_dup+0x58>
  if((fd=fdalloc(f)) < 0)
80104c06:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104c09:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c0b:	e8 a0 eb ff ff       	call   801037b0 <myproc>
80104c10:	eb 0e                	jmp    80104c20 <sys_dup+0x30>
80104c12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104c18:	83 c3 01             	add    $0x1,%ebx
80104c1b:	83 fb 10             	cmp    $0x10,%ebx
80104c1e:	74 28                	je     80104c48 <sys_dup+0x58>
    if(curproc->ofile[fd] == 0){
80104c20:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80104c24:	85 d2                	test   %edx,%edx
80104c26:	75 f0                	jne    80104c18 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104c28:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80104c2c:	83 ec 0c             	sub    $0xc,%esp
80104c2f:	ff 75 f4             	pushl  -0xc(%ebp)
80104c32:	e8 b9 c1 ff ff       	call   80100df0 <filedup>
  return fd;
...
80104c48:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80104c4b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
80104c50:	89 d8                	mov    %ebx,%eax
80104c52:	5b                   	pop    %ebx
80104c53:	5e                   	pop    %esi
80104c54:	5d                   	pop    %ebp
80104c55:	c3                   	ret    
...
80104cad:	e8 ae c2 ff ff       	call   80100f60 <fileread>
...
80104d1d:	e8 ce c2 ff ff       	call   80100ff0 <filewrite>
...
80104d53:	78 2b                	js     80104d80 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d55:	e8 56 ea ff ff       	call   801037b0 <myproc>
...
80104d6b:	e8 d0 c0 ff ff       	call   80100e40 <fileclose>
  return 0;
...
80104dc4:	e8 47 c1 ff ff       	call   80100f10 <filestat>
...
80104e58:	e8 83 c7 ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104e5d:	89 1c 24             	mov    %ebx,(%esp)
80104e60:	e8 0b c9 ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104e65:	58                   	pop    %eax
80104e66:	5a                   	pop    %edx
80104e67:	57                   	push   %edi
80104e68:	ff 75 d0             	pushl  -0x30(%ebp)
80104e6b:	e8 a0 d0 ff ff       	call   80101f10 <nameiparent>
...
80104e7d:	e8 0e c8 ff ff       	call   80101690 <ilock>
...
80104e93:	e8 98 cf ff ff       	call   80101e30 <dirlink>
...
80104ea3:	e8 78 ca ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104ea8:	89 1c 24             	mov    %ebx,(%esp)
80104eab:	e8 10 c9 ff ff       	call   801017c0 <iput>
  end_op();
...
80104ecc:	e8 4f ca ff ff       	call   80101920 <iunlockput>
    goto bad;
80104ed1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104ed4:	83 ec 0c             	sub    $0xc,%esp
80104ed7:	53                   	push   %ebx
80104ed8:	e8 b3 c7 ff ff       	call   80101690 <ilock>
  ip->nlink--;
80104edd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104ee2:	89 1c 24             	mov    %ebx,(%esp)
80104ee5:	e8 f6 c6 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
80104eea:	89 1c 24             	mov    %ebx,(%esp)
80104eed:	e8 2e ca ff ff       	call   80101920 <iunlockput>
  end_op();
...
80104f1d:	eb 9b                	jmp    80104eba <sys_link+0xda>
    end_op();
80104f1f:	e8 fc dc ff ff       	call   80102c20 <end_op>
    return -1;
80104f24:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f29:	eb 8f                	jmp    80104eba <sys_link+0xda>
80104f2b:	90                   	nop
...
{
80104f39:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
...
80104f49:	0f 88 77 01 00 00    	js     801050c6 <sys_unlink+0x196>
  if((dp = nameiparent(path, name)) == 0){
80104f4f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104f52:	e8 59 dc ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104f57:	83 ec 08             	sub    $0x8,%esp
80104f5a:	53                   	push   %ebx
80104f5b:	ff 75 c0             	pushl  -0x40(%ebp)
80104f5e:	e8 ad cf ff ff       	call   80101f10 <nameiparent>
80104f63:	83 c4 10             	add    $0x10,%esp
80104f66:	85 c0                	test   %eax,%eax
80104f68:	89 c6                	mov    %eax,%esi
80104f6a:	0f 84 60 01 00 00    	je     801050d0 <sys_unlink+0x1a0>
  ilock(dp);
80104f70:	83 ec 0c             	sub    $0xc,%esp
80104f73:	50                   	push   %eax
80104f74:	e8 17 c7 ff ff       	call   80101690 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104f79:	58                   	pop    %eax
80104f7a:	5a                   	pop    %edx
80104f7b:	68 d8 79 10 80       	push   $0x801079d8
80104f80:	53                   	push   %ebx
80104f81:	e8 1a cc ff ff       	call   80101ba0 <namecmp>
80104f86:	83 c4 10             	add    $0x10,%esp
80104f89:	85 c0                	test   %eax,%eax
80104f8b:	0f 84 03 01 00 00    	je     80105094 <sys_unlink+0x164>
80104f91:	83 ec 08             	sub    $0x8,%esp
80104f94:	68 d7 79 10 80       	push   $0x801079d7
80104f99:	53                   	push   %ebx
80104f9a:	e8 01 cc ff ff       	call   80101ba0 <namecmp>
80104f9f:	83 c4 10             	add    $0x10,%esp
80104fa2:	85 c0                	test   %eax,%eax
80104fa4:	0f 84 ea 00 00 00    	je     80105094 <sys_unlink+0x164>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104faa:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104fad:	83 ec 04             	sub    $0x4,%esp
80104fb0:	50                   	push   %eax
80104fb1:	53                   	push   %ebx
80104fb2:	56                   	push   %esi
80104fb3:	e8 08 cc ff ff       	call   80101bc0 <dirlookup>
80104fb8:	83 c4 10             	add    $0x10,%esp
80104fbb:	85 c0                	test   %eax,%eax
80104fbd:	89 c3                	mov    %eax,%ebx
80104fbf:	0f 84 cf 00 00 00    	je     80105094 <sys_unlink+0x164>
  ilock(ip);
80104fc5:	83 ec 0c             	sub    $0xc,%esp
80104fc8:	50                   	push   %eax
80104fc9:	e8 c2 c6 ff ff       	call   80101690 <ilock>
  if(ip->nlink < 1)
80104fce:	83 c4 10             	add    $0x10,%esp
80104fd1:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104fd6:	0f 8e 10 01 00 00    	jle    801050ec <sys_unlink+0x1bc>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104fdc:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104fe1:	74 6d                	je     80105050 <sys_unlink+0x120>
...
80104fee:	e8 bd f5 ff ff       	call   801045b0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104ff3:	8d 45 d8             	lea    -0x28(%ebp),%eax
80104ff6:	6a 10                	push   $0x10
80104ff8:	ff 75 c4             	pushl  -0x3c(%ebp)
80104ffb:	50                   	push   %eax
80104ffc:	56                   	push   %esi
80104ffd:	e8 6e ca ff ff       	call   80101a70 <writei>
80105002:	83 c4 20             	add    $0x20,%esp
80105005:	83 f8 10             	cmp    $0x10,%eax
80105008:	0f 85 eb 00 00 00    	jne    801050f9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
8010500e:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105013:	0f 84 97 00 00 00    	je     801050b0 <sys_unlink+0x180>
  iunlockput(dp);
80105019:	83 ec 0c             	sub    $0xc,%esp
8010501c:	56                   	push   %esi
8010501d:	e8 fe c8 ff ff       	call   80101920 <iunlockput>
  ip->nlink--;
80105022:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105027:	89 1c 24             	mov    %ebx,(%esp)
8010502a:	e8 b1 c5 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
8010502f:	89 1c 24             	mov    %ebx,(%esp)
80105032:	e8 e9 c8 ff ff       	call   80101920 <iunlockput>
  end_op();
80105037:	e8 e4 db ff ff       	call   80102c20 <end_op>
  return 0;
...
80105054:	76 8d                	jbe    80104fe3 <sys_unlink+0xb3>
...
80105066:	0f 83 77 ff ff ff    	jae    80104fe3 <sys_unlink+0xb3>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010506c:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010506f:	6a 10                	push   $0x10
80105071:	57                   	push   %edi
80105072:	50                   	push   %eax
80105073:	53                   	push   %ebx
80105074:	e8 f7 c8 ff ff       	call   80101970 <readi>
80105079:	83 c4 10             	add    $0x10,%esp
8010507c:	83 f8 10             	cmp    $0x10,%eax
8010507f:	75 5e                	jne    801050df <sys_unlink+0x1af>
    if(de.inum != 0)
80105081:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105086:	74 d8                	je     80105060 <sys_unlink+0x130>
    iunlockput(ip);
...
80105098:	e8 83 c8 ff ff       	call   80101920 <iunlockput>
  end_op();
8010509d:	e8 7e db ff ff       	call   80102c20 <end_op>
  return -1;
801050a2:	83 c4 10             	add    $0x10,%esp
801050a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050aa:	eb 95                	jmp    80105041 <sys_unlink+0x111>
801050ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink--;
801050b0:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
801050b5:	83 ec 0c             	sub    $0xc,%esp
801050b8:	56                   	push   %esi
801050b9:	e8 22 c5 ff ff       	call   801015e0 <iupdate>
801050be:	83 c4 10             	add    $0x10,%esp
801050c1:	e9 53 ff ff ff       	jmp    80105019 <sys_unlink+0xe9>
    return -1;
801050c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050cb:	e9 71 ff ff ff       	jmp    80105041 <sys_unlink+0x111>
    end_op();
801050d0:	e8 4b db ff ff       	call   80102c20 <end_op>
    return -1;
801050d5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050da:	e9 62 ff ff ff       	jmp    80105041 <sys_unlink+0x111>
      panic("isdirempty: readi");
801050df:	83 ec 0c             	sub    $0xc,%esp
801050e2:	68 fc 79 10 80       	push   $0x801079fc
801050e7:	e8 a4 b2 ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
801050ec:	83 ec 0c             	sub    $0xc,%esp
801050ef:	68 ea 79 10 80       	push   $0x801079ea
801050f4:	e8 97 b2 ff ff       	call   80100390 <panic>
    panic("unlink: writei");
801050f9:	83 ec 0c             	sub    $0xc,%esp
801050fc:	68 0e 7a 10 80       	push   $0x80107a0e
80105101:	e8 8a b2 ff ff       	call   80100390 <panic>
...
8010511f:	e8 3c f8 ff ff       	call   80104960 <argstr>
80105124:	83 c4 10             	add    $0x10,%esp
80105127:	85 c0                	test   %eax,%eax
80105129:	0f 88 1d 01 00 00    	js     8010524c <sys_open+0x13c>
8010512f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105132:	83 ec 08             	sub    $0x8,%esp
80105135:	50                   	push   %eax
80105136:	6a 01                	push   $0x1
80105138:	e8 73 f7 ff ff       	call   801048b0 <argint>
8010513d:	83 c4 10             	add    $0x10,%esp
80105140:	85 c0                	test   %eax,%eax
80105142:	0f 88 04 01 00 00    	js     8010524c <sys_open+0x13c>
    return -1;

  begin_op();
80105148:	e8 63 da ff ff       	call   80102bb0 <begin_op>

  if(omode & O_CREATE){
8010514d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105151:	0f 85 a9 00 00 00    	jne    80105200 <sys_open+0xf0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
8010515d:	e8 8e cd ff ff       	call   80101ef0 <namei>
80105162:	83 c4 10             	add    $0x10,%esp
80105165:	85 c0                	test   %eax,%eax
80105167:	89 c6                	mov    %eax,%esi
80105169:	0f 84 b2 00 00 00    	je     80105221 <sys_open+0x111>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105173:	e8 18 c5 ff ff       	call   80101690 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105178:	83 c4 10             	add    $0x10,%esp
8010517b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105180:	0f 84 aa 00 00 00    	je     80105230 <sys_open+0x120>
      end_op();
      return -1;
    }
  }
...
80105186:	e8 f5 bb ff ff       	call   80100d80 <filealloc>
8010518b:	85 c0                	test   %eax,%eax
8010518d:	89 c7                	mov    %eax,%edi
8010518f:	0f 84 a6 00 00 00    	je     8010523b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105195:	e8 16 e6 ff ff       	call   801037b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010519a:	31 db                	xor    %ebx,%ebx
8010519c:	eb 0e                	jmp    801051ac <sys_open+0x9c>
8010519e:	66 90                	xchg   %ax,%ax
801051a0:	83 c3 01             	add    $0x1,%ebx
801051a3:	83 fb 10             	cmp    $0x10,%ebx
801051a6:	0f 84 ac 00 00 00    	je     80105258 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
801051ac:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
801051b0:	85 d2                	test   %edx,%edx
801051b2:	75 ec                	jne    801051a0 <sys_open+0x90>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801051b4:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801051b7:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
801051bb:	56                   	push   %esi
801051bc:	e8 af c5 ff ff       	call   80101770 <iunlock>
  end_op();
801051c1:	e8 5a da ff ff       	call   80102c20 <end_op>

  f->type = FD_INODE;
801051c6:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801051cc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051cf:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
801051d2:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
801051d5:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801051dc:	89 d0                	mov    %edx,%eax
801051de:	f7 d0                	not    %eax
801051e0:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051e3:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
801051e6:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051e9:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
...
80105219:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010521b:	0f 85 65 ff ff ff    	jne    80105186 <sys_open+0x76>
      end_op();
80105221:	e8 fa d9 ff ff       	call   80102c20 <end_op>
      return -1;
80105226:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010522b:	eb c0                	jmp    801051ed <sys_open+0xdd>
8010522d:	8d 76 00             	lea    0x0(%esi),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
80105230:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105233:	85 c9                	test   %ecx,%ecx
80105235:	0f 84 4b ff ff ff    	je     80105186 <sys_open+0x76>
    iunlockput(ip);
8010523b:	83 ec 0c             	sub    $0xc,%esp
8010523e:	56                   	push   %esi
8010523f:	e8 dc c6 ff ff       	call   80101920 <iunlockput>
    end_op();
80105244:	e8 d7 d9 ff ff       	call   80102c20 <end_op>
    return -1;
80105249:	83 c4 10             	add    $0x10,%esp
8010524c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105251:	eb 9a                	jmp    801051ed <sys_open+0xdd>
80105253:	90                   	nop
80105254:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      fileclose(f);
80105258:	83 ec 0c             	sub    $0xc,%esp
8010525b:	57                   	push   %edi
8010525c:	e8 df bb ff ff       	call   80100e40 <fileclose>
80105261:	83 c4 10             	add    $0x10,%esp
80105264:	eb d5                	jmp    8010523b <sys_open+0x12b>
...
80105284:	e8 d7 f6 ff ff       	call   80104960 <argstr>
...
8010529f:	e8 5c f7 ff ff       	call   80104a00 <create>
...
801052af:	e8 6c c6 ff ff       	call   80101920 <iunlockput>
  end_op();
801052b4:	e8 67 d9 ff ff       	call   80102c20 <end_op>
  return 0;
...
801052f9:	e8 b2 f5 ff ff       	call   801048b0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010530e:	e8 9d f5 ff ff       	call   801048b0 <argint>
     argint(1, &major) < 0 ||
...
8010532e:	e8 cd f6 ff ff       	call   80104a00 <create>
...
8010533e:	e8 dd c5 ff ff       	call   80101920 <iunlockput>
  end_op();
80105343:	e8 d8 d8 ff ff       	call   80102c20 <end_op>
  return 0;
...
8010538f:	e8 5c cb ff ff       	call   80101ef0 <namei>
...
801053a1:	e8 ea c2 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
801053b4:	e8 b7 c3 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
801053b9:	58                   	pop    %eax
801053ba:	ff 76 68             	pushl  0x68(%esi)
801053bd:	e8 fe c3 ff ff       	call   801017c0 <iput>
  end_op();
801053c2:	e8 59 d8 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
...
801053e4:	e8 37 c5 ff ff       	call   80101920 <iunlockput>
    end_op();
801053e9:	e8 32 d8 ff ff       	call   80102c20 <end_op>
    return -1;
...
8010544d:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
...
80105466:	e8 45 f1 ff ff       	call   801045b0 <memset>
8010546b:	83 c4 10             	add    $0x10,%esp
8010546e:	eb 2c                	jmp    8010549c <sys_exec+0x8c>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
      return -1;
    if(uarg == 0){
80105470:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105476:	85 c0                	test   %eax,%eax
80105478:	74 56                	je     801054d0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
8010547a:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105480:	83 ec 08             	sub    $0x8,%esp
80105483:	8d 14 31             	lea    (%ecx,%esi,1),%edx
80105486:	52                   	push   %edx
80105487:	50                   	push   %eax
80105488:	e8 b3 f3 ff ff       	call   80104840 <fetchstr>
8010548d:	83 c4 10             	add    $0x10,%esp
80105490:	85 c0                	test   %eax,%eax
80105492:	78 28                	js     801054bc <sys_exec+0xac>
  for(i=0;; i++){
80105494:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80105497:	83 fb 20             	cmp    $0x20,%ebx
8010549a:	74 20                	je     801054bc <sys_exec+0xac>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010549c:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801054a2:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
801054a9:	83 ec 08             	sub    $0x8,%esp
801054ac:	57                   	push   %edi
801054ad:	01 f0                	add    %esi,%eax
801054af:	50                   	push   %eax
801054b0:	e8 4b f3 ff ff       	call   80104800 <fetchint>
801054b5:	83 c4 10             	add    $0x10,%esp
801054b8:	85 c0                	test   %eax,%eax
801054ba:	79 b4                	jns    80105470 <sys_exec+0x60>
      return -1;
  }
...
801054eb:	e8 20 b5 ff ff       	call   80100a10 <exec>
...
80105511:	e8 ea f3 ff ff       	call   80104900 <argptr>
80105516:	83 c4 10             	add    $0x10,%esp
80105519:	85 c0                	test   %eax,%eax
8010551b:	0f 88 ae 00 00 00    	js     801055cf <sys_pipe+0xcf>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80105521:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105524:	83 ec 08             	sub    $0x8,%esp
80105527:	50                   	push   %eax
80105528:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010552b:	50                   	push   %eax
8010552c:	e8 0f dd ff ff       	call   80103240 <pipealloc>
80105531:	83 c4 10             	add    $0x10,%esp
80105534:	85 c0                	test   %eax,%eax
80105536:	0f 88 93 00 00 00    	js     801055cf <sys_pipe+0xcf>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010553c:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
8010553f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105541:	e8 6a e2 ff ff       	call   801037b0 <myproc>
80105546:	eb 10                	jmp    80105558 <sys_pipe+0x58>
80105548:	90                   	nop
80105549:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(fd = 0; fd < NOFILE; fd++){
80105550:	83 c3 01             	add    $0x1,%ebx
80105553:	83 fb 10             	cmp    $0x10,%ebx
80105556:	74 60                	je     801055b8 <sys_pipe+0xb8>
    if(curproc->ofile[fd] == 0){
80105558:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
8010555c:	85 f6                	test   %esi,%esi
8010555e:	75 f0                	jne    80105550 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
...
80105567:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010556a:	e8 41 e2 ff ff       	call   801037b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010556f:	31 d2                	xor    %edx,%edx
80105571:	eb 0d                	jmp    80105580 <sys_pipe+0x80>
80105573:	90                   	nop
80105574:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105578:	83 c2 01             	add    $0x1,%edx
8010557b:	83 fa 10             	cmp    $0x10,%edx
8010557e:	74 28                	je     801055a8 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
80105580:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80105584:	85 c9                	test   %ecx,%ecx
80105586:	75 f0                	jne    80105578 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105588:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
8010558c:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010558f:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
80105591:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105594:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
...
801055a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801055a8:	e8 03 e2 ff ff       	call   801037b0 <myproc>
801055ad:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801055b4:	00 
801055b5:	8d 76 00             	lea    0x0(%esi),%esi
    fileclose(rf);
801055b8:	83 ec 0c             	sub    $0xc,%esp
801055bb:	ff 75 e0             	pushl  -0x20(%ebp)
801055be:	e8 7d b8 ff ff       	call   80100e40 <fileclose>
    fileclose(wf);
801055c3:	58                   	pop    %eax
801055c4:	ff 75 e4             	pushl  -0x1c(%ebp)
801055c7:	e8 74 b8 ff ff       	call   80100e40 <fileclose>
    return -1;
801055cc:	83 c4 10             	add    $0x10,%esp
801055cf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055d4:	eb c3                	jmp    80105599 <sys_pipe+0x99>
801055d6:	66 90                	xchg   %ax,%ax
801055d8:	66 90                	xchg   %ax,%ax
801055da:	66 90                	xchg   %ax,%ax
801055dc:	66 90                	xchg   %ax,%ax
...
801055ec:	e8 bf f2 ff ff       	call   801048b0 <argint>
801055f1:	83 c4 10             	add    $0x10,%esp
801055f4:	85 c0                	test   %eax,%eax
801055f6:	78 18                	js     80105610 <sys_fork+0x30>
    return -1;
  return fork(tickets);
801055f8:	83 ec 0c             	sub    $0xc,%esp
801055fb:	ff 75 f4             	pushl  -0xc(%ebp)
801055fe:	e8 4d e3 ff ff       	call   80103950 <fork>
...
80105623:	83 ec 08             	sub    $0x8,%esp
  exit();
80105626:	e8 f5 e6 ff ff       	call   80103d20 <exit>
...
80105633:	5d                   	pop    %ebp
  return wait();
80105634:	e9 27 e9 ff ff       	jmp    80103f60 <wait>
...
8010564c:	e8 5f f2 ff ff       	call   801048b0 <argint>
...
8010565e:	e8 4d ea ff ff       	call   801040b0 <kill>
...
80105683:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105686:	e8 25 e1 ff ff       	call   801037b0 <myproc>
...
801056a7:	78 27                	js     801056d0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801056a9:	e8 02 e1 ff ff       	call   801037b0 <myproc>
  if(growproc(n) < 0)
...
801056b6:	e8 15 e2 ff ff       	call   801038d0 <growproc>
...
801056d5:	eb eb                	jmp    801056c2 <sys_sbrk+0x32>
...
801056ed:	e8 be f1 ff ff       	call   801048b0 <argint>
...
80105700:	68 40 52 11 80       	push   $0x80115240
80105705:	e8 96 ed ff ff       	call   801044a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010570a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010570d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105710:	8b 1d 80 5a 11 80    	mov    0x80115a80,%ebx
  while(ticks - ticks0 < n){
...
80105723:	68 40 52 11 80       	push   $0x80115240
80105728:	68 80 5a 11 80       	push   $0x80115a80
8010572d:	e8 6e e7 ff ff       	call   80103ea0 <sleep>
  while(ticks - ticks0 < n){
80105732:	a1 80 5a 11 80       	mov    0x80115a80,%eax
...
8010573f:	73 2f                	jae    80105770 <sys_sleep+0x90>
    if(myproc()->killed){
80105741:	e8 6a e0 ff ff       	call   801037b0 <myproc>
...
80105755:	e8 06 ee ff ff       	call   80104560 <release>
      return -1;
...
80105778:	e8 e3 ed ff ff       	call   80104560 <release>
  return 0;
...
8010578c:	eb f4                	jmp    80105782 <sys_sleep+0xa2>
...
80105794:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105797:	68 40 52 11 80       	push   $0x80115240
8010579c:	e8 ff ec ff ff       	call   801044a0 <acquire>
  xticks = ticks;
801057a1:	8b 1d 80 5a 11 80    	mov    0x80115a80,%ebx
  release(&tickslock);
801057a7:	c7 04 24 40 52 11 80 	movl   $0x80115240,(%esp)
801057ae:	e8 ad ed ff ff       	call   80104560 <release>
  return xticks;
}
...
801057cc:	e8 df f0 ff ff       	call   801048b0 <argint>
      return  -1;
  }
...
801057d1:	c9                   	leave  
  if(argint(0, &n) < 0)
801057d2:	c1 f8 1f             	sar    $0x1f,%eax
}
801057d5:	c3                   	ret    
...
801057d7:	06                   	push   %es
  pushl %fs
801057d8:	0f a0                	push   %fs
  pushl %gs
801057da:	0f a8                	push   %gs
  pushal
801057dc:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801057dd:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801057e1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801057e3:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801057e5:	54                   	push   %esp
  call trap
801057e6:	e8 c5 00 00 00       	call   801058b0 <trap>
  addl $4, %esp
801057eb:	83 c4 04             	add    $0x4,%esp
...
801057ee:	61                   	popa   
  popl %gs
801057ef:	0f a9                	pop    %gs
  popl %fs
801057f1:	0f a1                	pop    %fs
  popl %es
801057f3:	07                   	pop    %es
  popl %ds
801057f4:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801057f5:	83 c4 08             	add    $0x8,%esp
  iret
801057f8:	cf                   	iret   
...
80105817:	c7 04 c5 82 52 11 80 	movl   $0x8e000008,-0x7feead7e(,%eax,8)
8010581e:	08 00 00 8e 
80105822:	66 89 14 c5 80 52 11 	mov    %dx,-0x7feead80(,%eax,8)
80105829:	80 
8010582a:	c1 ea 10             	shr    $0x10,%edx
8010582d:	66 89 14 c5 86 52 11 	mov    %dx,-0x7feead7a(,%eax,8)
80105834:	80 
  for(i = 0; i < 256; i++)
...
80105844:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105847:	c7 05 82 54 11 80 08 	movl   $0xef000008,0x80115482
8010584e:	00 00 ef 
  initlock(&tickslock, "time");
80105851:	68 1d 7a 10 80       	push   $0x80107a1d
80105856:	68 40 52 11 80       	push   $0x80115240
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010585b:	66 a3 80 54 11 80    	mov    %ax,0x80115480
80105861:	c1 e8 10             	shr    $0x10,%eax
80105864:	66 a3 86 54 11 80    	mov    %ax,0x80115486
  initlock(&tickslock, "time");
...
8010588b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010588f:	b8 80 52 11 80       	mov    $0x80115280,%eax
...
801058d0:	ff 24 85 c4 7a 10 80 	jmp    *-0x7fef853c(,%eax,4)
...
801058e0:	e8 cb de ff ff       	call   801037b0 <myproc>
...
80105900:	e8 8b de ff ff       	call   80103790 <cpuid>
...
80105911:	e8 9a de ff ff       	call   801037b0 <myproc>
...
80105935:	68 80 7a 10 80       	push   $0x80107a80
8010593a:	e8 21 ad ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010593f:	83 c4 20             	add    $0x20,%esp
80105942:	e8 69 de ff ff       	call   801037b0 <myproc>
...
8010594e:	e8 5d de ff ff       	call   801037b0 <myproc>
80105953:	85 c0                	test   %eax,%eax
80105955:	74 1d                	je     80105974 <trap+0xc4>
80105957:	e8 54 de ff ff       	call   801037b0 <myproc>
...
80105974:	e8 37 de ff ff       	call   801037b0 <myproc>
80105979:	85 c0                	test   %eax,%eax
8010597b:	74 0b                	je     80105988 <trap+0xd8>
8010597d:	e8 2e de ff ff       	call   801037b0 <myproc>
...
80105991:	e8 1a de ff ff       	call   801037b0 <myproc>
...
801059b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
801059b8:	e8 f3 dd ff ff       	call   801037b0 <myproc>
801059bd:	8b 58 24             	mov    0x24(%eax),%ebx
801059c0:	85 db                	test   %ebx,%ebx
801059c2:	0f 85 e8 00 00 00    	jne    80105ab0 <trap+0x200>
    myproc()->tf = tf;
801059c8:	e8 e3 dd ff ff       	call   801037b0 <myproc>
801059cd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059d0:	e8 cb ef ff ff       	call   801049a0 <syscall>
    if(myproc()->killed)
801059d5:	e8 d6 dd ff ff       	call   801037b0 <myproc>
...
80105a24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105a28:	e8 f3 cb ff ff       	call   80102620 <kbdintr>
    lapiceoi();
80105a2d:	e8 2e cd ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a32:	e8 79 dd ff ff       	call   801037b0 <myproc>
...
80105a4d:	e8 0e cd ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a52:	e8 59 dd ff ff       	call   801037b0 <myproc>
...
80105a6f:	e8 1c dd ff ff       	call   80103790 <cpuid>
80105a74:	56                   	push   %esi
80105a75:	53                   	push   %ebx
80105a76:	50                   	push   %eax
80105a77:	68 28 7a 10 80       	push   $0x80107a28
80105a7c:	e8 df ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a81:	e8 da cc ff ff       	call   80102760 <lapiceoi>
    break;
80105a86:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a89:	e8 22 dd ff ff       	call   801037b0 <myproc>
...
80105a9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105aa0:	e8 eb c5 ff ff       	call   80102090 <ideintr>
...
80105aba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105ac0:	e8 5b e2 ff ff       	call   80103d20 <exit>
...
80105b04:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b07:	e8 84 dc ff ff       	call   80103790 <cpuid>
...
80105b15:	68 4c 7a 10 80       	push   $0x80107a4c
80105b1a:	e8 41 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b1f:	83 c4 14             	add    $0x14,%esp
80105b22:	68 22 7a 10 80       	push   $0x80107a22
...
80105b85:	e8 f6 cb ff ff       	call   80102780 <microdelay>
...
80105c1c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c1f:	bb 44 7b 10 80       	mov    $0x80107b44,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c24:	6a 00                	push   $0x0
80105c26:	6a 04                	push   $0x4
80105c28:	e8 b3 c6 ff ff       	call   801022e0 <ioapicenable>
...
80105cb7:	6a 00                	push   $0x0
  jmp alltraps
80105cb9:	e9 18 fb ff ff       	jmp    801057d6 <alltraps>
...
80105cc0:	6a 01                	push   $0x1
  jmp alltraps
80105cc2:	e9 0f fb ff ff       	jmp    801057d6 <alltraps>
...
80105cc9:	6a 02                	push   $0x2
  jmp alltraps
80105ccb:	e9 06 fb ff ff       	jmp    801057d6 <alltraps>
...
80105cd2:	6a 03                	push   $0x3
  jmp alltraps
80105cd4:	e9 fd fa ff ff       	jmp    801057d6 <alltraps>
...
80105cdb:	6a 04                	push   $0x4
  jmp alltraps
80105cdd:	e9 f4 fa ff ff       	jmp    801057d6 <alltraps>
...
80105ce4:	6a 05                	push   $0x5
  jmp alltraps
80105ce6:	e9 eb fa ff ff       	jmp    801057d6 <alltraps>
...
80105ced:	6a 06                	push   $0x6
  jmp alltraps
80105cef:	e9 e2 fa ff ff       	jmp    801057d6 <alltraps>
...
80105cf6:	6a 07                	push   $0x7
  jmp alltraps
80105cf8:	e9 d9 fa ff ff       	jmp    801057d6 <alltraps>
...
80105cfd:	6a 08                	push   $0x8
  jmp alltraps
80105cff:	e9 d2 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d06:	6a 09                	push   $0x9
  jmp alltraps
80105d08:	e9 c9 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d0d:	6a 0a                	push   $0xa
  jmp alltraps
80105d0f:	e9 c2 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d14:	6a 0b                	push   $0xb
  jmp alltraps
80105d16:	e9 bb fa ff ff       	jmp    801057d6 <alltraps>
...
80105d1b:	6a 0c                	push   $0xc
  jmp alltraps
80105d1d:	e9 b4 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d22:	6a 0d                	push   $0xd
  jmp alltraps
80105d24:	e9 ad fa ff ff       	jmp    801057d6 <alltraps>
...
80105d29:	6a 0e                	push   $0xe
  jmp alltraps
80105d2b:	e9 a6 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d32:	6a 0f                	push   $0xf
  jmp alltraps
80105d34:	e9 9d fa ff ff       	jmp    801057d6 <alltraps>
...
80105d3b:	6a 10                	push   $0x10
  jmp alltraps
80105d3d:	e9 94 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d42:	6a 11                	push   $0x11
  jmp alltraps
80105d44:	e9 8d fa ff ff       	jmp    801057d6 <alltraps>
...
80105d4b:	6a 12                	push   $0x12
  jmp alltraps
80105d4d:	e9 84 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d54:	6a 13                	push   $0x13
  jmp alltraps
80105d56:	e9 7b fa ff ff       	jmp    801057d6 <alltraps>
...
80105d5d:	6a 14                	push   $0x14
  jmp alltraps
80105d5f:	e9 72 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d66:	6a 15                	push   $0x15
  jmp alltraps
80105d68:	e9 69 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d6f:	6a 16                	push   $0x16
  jmp alltraps
80105d71:	e9 60 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d78:	6a 17                	push   $0x17
  jmp alltraps
80105d7a:	e9 57 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d81:	6a 18                	push   $0x18
  jmp alltraps
80105d83:	e9 4e fa ff ff       	jmp    801057d6 <alltraps>
...
80105d8a:	6a 19                	push   $0x19
  jmp alltraps
80105d8c:	e9 45 fa ff ff       	jmp    801057d6 <alltraps>
...
80105d93:	6a 1a                	push   $0x1a
  jmp alltraps
80105d95:	e9 3c fa ff ff       	jmp    801057d6 <alltraps>
...
80105d9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d9e:	e9 33 fa ff ff       	jmp    801057d6 <alltraps>
...
80105da5:	6a 1c                	push   $0x1c
  jmp alltraps
80105da7:	e9 2a fa ff ff       	jmp    801057d6 <alltraps>
...
80105dae:	6a 1d                	push   $0x1d
  jmp alltraps
80105db0:	e9 21 fa ff ff       	jmp    801057d6 <alltraps>
...
80105db7:	6a 1e                	push   $0x1e
  jmp alltraps
80105db9:	e9 18 fa ff ff       	jmp    801057d6 <alltraps>
...
80105dc0:	6a 1f                	push   $0x1f
  jmp alltraps
80105dc2:	e9 0f fa ff ff       	jmp    801057d6 <alltraps>
...
80105dc9:	6a 20                	push   $0x20
  jmp alltraps
80105dcb:	e9 06 fa ff ff       	jmp    801057d6 <alltraps>
...
80105dd2:	6a 21                	push   $0x21
  jmp alltraps
80105dd4:	e9 fd f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ddb:	6a 22                	push   $0x22
  jmp alltraps
80105ddd:	e9 f4 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105de4:	6a 23                	push   $0x23
  jmp alltraps
80105de6:	e9 eb f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ded:	6a 24                	push   $0x24
  jmp alltraps
80105def:	e9 e2 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105df6:	6a 25                	push   $0x25
  jmp alltraps
80105df8:	e9 d9 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105dff:	6a 26                	push   $0x26
  jmp alltraps
80105e01:	e9 d0 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e08:	6a 27                	push   $0x27
  jmp alltraps
80105e0a:	e9 c7 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e11:	6a 28                	push   $0x28
  jmp alltraps
80105e13:	e9 be f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e1a:	6a 29                	push   $0x29
  jmp alltraps
80105e1c:	e9 b5 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e23:	6a 2a                	push   $0x2a
  jmp alltraps
80105e25:	e9 ac f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e2c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e2e:	e9 a3 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e35:	6a 2c                	push   $0x2c
  jmp alltraps
80105e37:	e9 9a f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e3e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e40:	e9 91 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e47:	6a 2e                	push   $0x2e
  jmp alltraps
80105e49:	e9 88 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e50:	6a 2f                	push   $0x2f
  jmp alltraps
80105e52:	e9 7f f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e59:	6a 30                	push   $0x30
  jmp alltraps
80105e5b:	e9 76 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e62:	6a 31                	push   $0x31
  jmp alltraps
80105e64:	e9 6d f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e6b:	6a 32                	push   $0x32
  jmp alltraps
80105e6d:	e9 64 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e74:	6a 33                	push   $0x33
  jmp alltraps
80105e76:	e9 5b f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e7d:	6a 34                	push   $0x34
  jmp alltraps
80105e7f:	e9 52 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e86:	6a 35                	push   $0x35
  jmp alltraps
80105e88:	e9 49 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e8f:	6a 36                	push   $0x36
  jmp alltraps
80105e91:	e9 40 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105e98:	6a 37                	push   $0x37
  jmp alltraps
80105e9a:	e9 37 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ea1:	6a 38                	push   $0x38
  jmp alltraps
80105ea3:	e9 2e f9 ff ff       	jmp    801057d6 <alltraps>
...
80105eaa:	6a 39                	push   $0x39
  jmp alltraps
80105eac:	e9 25 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105eb3:	6a 3a                	push   $0x3a
  jmp alltraps
80105eb5:	e9 1c f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ebc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ebe:	e9 13 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ec5:	6a 3c                	push   $0x3c
  jmp alltraps
80105ec7:	e9 0a f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ece:	6a 3d                	push   $0x3d
  jmp alltraps
80105ed0:	e9 01 f9 ff ff       	jmp    801057d6 <alltraps>
...
80105ed7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ed9:	e9 f8 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105ee0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ee2:	e9 ef f8 ff ff       	jmp    801057d6 <alltraps>
...
80105ee9:	6a 40                	push   $0x40
  jmp alltraps
80105eeb:	e9 e6 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105ef2:	6a 41                	push   $0x41
  jmp alltraps
80105ef4:	e9 dd f8 ff ff       	jmp    801057d6 <alltraps>
...
80105efb:	6a 42                	push   $0x42
  jmp alltraps
80105efd:	e9 d4 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f04:	6a 43                	push   $0x43
  jmp alltraps
80105f06:	e9 cb f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f0d:	6a 44                	push   $0x44
  jmp alltraps
80105f0f:	e9 c2 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f16:	6a 45                	push   $0x45
  jmp alltraps
80105f18:	e9 b9 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f1f:	6a 46                	push   $0x46
  jmp alltraps
80105f21:	e9 b0 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f28:	6a 47                	push   $0x47
  jmp alltraps
80105f2a:	e9 a7 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f31:	6a 48                	push   $0x48
  jmp alltraps
80105f33:	e9 9e f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f3a:	6a 49                	push   $0x49
  jmp alltraps
80105f3c:	e9 95 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f43:	6a 4a                	push   $0x4a
  jmp alltraps
80105f45:	e9 8c f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f4c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f4e:	e9 83 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f55:	6a 4c                	push   $0x4c
  jmp alltraps
80105f57:	e9 7a f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f5e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f60:	e9 71 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f67:	6a 4e                	push   $0x4e
  jmp alltraps
80105f69:	e9 68 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f70:	6a 4f                	push   $0x4f
  jmp alltraps
80105f72:	e9 5f f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f79:	6a 50                	push   $0x50
  jmp alltraps
80105f7b:	e9 56 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f82:	6a 51                	push   $0x51
  jmp alltraps
80105f84:	e9 4d f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f8b:	6a 52                	push   $0x52
  jmp alltraps
80105f8d:	e9 44 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f94:	6a 53                	push   $0x53
  jmp alltraps
80105f96:	e9 3b f8 ff ff       	jmp    801057d6 <alltraps>
...
80105f9d:	6a 54                	push   $0x54
  jmp alltraps
80105f9f:	e9 32 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105fa6:	6a 55                	push   $0x55
  jmp alltraps
80105fa8:	e9 29 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105faf:	6a 56                	push   $0x56
  jmp alltraps
80105fb1:	e9 20 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105fb8:	6a 57                	push   $0x57
  jmp alltraps
80105fba:	e9 17 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105fc1:	6a 58                	push   $0x58
  jmp alltraps
80105fc3:	e9 0e f8 ff ff       	jmp    801057d6 <alltraps>
...
80105fca:	6a 59                	push   $0x59
  jmp alltraps
80105fcc:	e9 05 f8 ff ff       	jmp    801057d6 <alltraps>
...
80105fd3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fd5:	e9 fc f7 ff ff       	jmp    801057d6 <alltraps>
...
80105fdc:	6a 5b                	push   $0x5b
  jmp alltraps
80105fde:	e9 f3 f7 ff ff       	jmp    801057d6 <alltraps>
...
80105fe5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fe7:	e9 ea f7 ff ff       	jmp    801057d6 <alltraps>
...
80105fee:	6a 5d                	push   $0x5d
  jmp alltraps
80105ff0:	e9 e1 f7 ff ff       	jmp    801057d6 <alltraps>
...
80105ff7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ff9:	e9 d8 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106000:	6a 5f                	push   $0x5f
  jmp alltraps
80106002:	e9 cf f7 ff ff       	jmp    801057d6 <alltraps>
...
80106009:	6a 60                	push   $0x60
  jmp alltraps
8010600b:	e9 c6 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106012:	6a 61                	push   $0x61
  jmp alltraps
80106014:	e9 bd f7 ff ff       	jmp    801057d6 <alltraps>
...
8010601b:	6a 62                	push   $0x62
  jmp alltraps
8010601d:	e9 b4 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106024:	6a 63                	push   $0x63
  jmp alltraps
80106026:	e9 ab f7 ff ff       	jmp    801057d6 <alltraps>
...
8010602d:	6a 64                	push   $0x64
  jmp alltraps
8010602f:	e9 a2 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106036:	6a 65                	push   $0x65
  jmp alltraps
80106038:	e9 99 f7 ff ff       	jmp    801057d6 <alltraps>
...
8010603f:	6a 66                	push   $0x66
  jmp alltraps
80106041:	e9 90 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106048:	6a 67                	push   $0x67
  jmp alltraps
8010604a:	e9 87 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106051:	6a 68                	push   $0x68
  jmp alltraps
80106053:	e9 7e f7 ff ff       	jmp    801057d6 <alltraps>
...
8010605a:	6a 69                	push   $0x69
  jmp alltraps
8010605c:	e9 75 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106063:	6a 6a                	push   $0x6a
  jmp alltraps
80106065:	e9 6c f7 ff ff       	jmp    801057d6 <alltraps>
...
8010606c:	6a 6b                	push   $0x6b
  jmp alltraps
8010606e:	e9 63 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106075:	6a 6c                	push   $0x6c
  jmp alltraps
80106077:	e9 5a f7 ff ff       	jmp    801057d6 <alltraps>
...
8010607e:	6a 6d                	push   $0x6d
  jmp alltraps
80106080:	e9 51 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106087:	6a 6e                	push   $0x6e
  jmp alltraps
80106089:	e9 48 f7 ff ff       	jmp    801057d6 <alltraps>
...
80106090:	6a 6f                	push   $0x6f
  jmp alltraps
80106092:	e9 3f f7 ff ff       	jmp    801057d6 <alltraps>
...
80106099:	6a 70                	push   $0x70
  jmp alltraps
8010609b:	e9 36 f7 ff ff       	jmp    801057d6 <alltraps>
...
801060a2:	6a 71                	push   $0x71
  jmp alltraps
801060a4:	e9 2d f7 ff ff       	jmp    801057d6 <alltraps>
...
801060ab:	6a 72                	push   $0x72
  jmp alltraps
801060ad:	e9 24 f7 ff ff       	jmp    801057d6 <alltraps>
...
801060b4:	6a 73                	push   $0x73
  jmp alltraps
801060b6:	e9 1b f7 ff ff       	jmp    801057d6 <alltraps>
...
801060bd:	6a 74                	push   $0x74
  jmp alltraps
801060bf:	e9 12 f7 ff ff       	jmp    801057d6 <alltraps>
...
801060c6:	6a 75                	push   $0x75
  jmp alltraps
801060c8:	e9 09 f7 ff ff       	jmp    801057d6 <alltraps>
...
801060cf:	6a 76                	push   $0x76
  jmp alltraps
801060d1:	e9 00 f7 ff ff       	jmp    801057d6 <alltraps>
...
801060d8:	6a 77                	push   $0x77
  jmp alltraps
801060da:	e9 f7 f6 ff ff       	jmp    801057d6 <alltraps>
...
801060e1:	6a 78                	push   $0x78
  jmp alltraps
801060e3:	e9 ee f6 ff ff       	jmp    801057d6 <alltraps>
...
801060ea:	6a 79                	push   $0x79
  jmp alltraps
801060ec:	e9 e5 f6 ff ff       	jmp    801057d6 <alltraps>
...
801060f3:	6a 7a                	push   $0x7a
  jmp alltraps
801060f5:	e9 dc f6 ff ff       	jmp    801057d6 <alltraps>
...
801060fc:	6a 7b                	push   $0x7b
  jmp alltraps
801060fe:	e9 d3 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106105:	6a 7c                	push   $0x7c
  jmp alltraps
80106107:	e9 ca f6 ff ff       	jmp    801057d6 <alltraps>
...
8010610e:	6a 7d                	push   $0x7d
  jmp alltraps
80106110:	e9 c1 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106117:	6a 7e                	push   $0x7e
  jmp alltraps
80106119:	e9 b8 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106120:	6a 7f                	push   $0x7f
  jmp alltraps
80106122:	e9 af f6 ff ff       	jmp    801057d6 <alltraps>
...
80106129:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010612e:	e9 a3 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106135:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010613a:	e9 97 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106141:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106146:	e9 8b f6 ff ff       	jmp    801057d6 <alltraps>
...
8010614d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106152:	e9 7f f6 ff ff       	jmp    801057d6 <alltraps>
...
80106159:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010615e:	e9 73 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106165:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010616a:	e9 67 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106171:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106176:	e9 5b f6 ff ff       	jmp    801057d6 <alltraps>
...
8010617d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106182:	e9 4f f6 ff ff       	jmp    801057d6 <alltraps>
...
80106189:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010618e:	e9 43 f6 ff ff       	jmp    801057d6 <alltraps>
...
80106195:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010619a:	e9 37 f6 ff ff       	jmp    801057d6 <alltraps>
...
801061a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801061a6:	e9 2b f6 ff ff       	jmp    801057d6 <alltraps>
...
801061ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061b2:	e9 1f f6 ff ff       	jmp    801057d6 <alltraps>
...
801061b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061be:	e9 13 f6 ff ff       	jmp    801057d6 <alltraps>
...
801061c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061ca:	e9 07 f6 ff ff       	jmp    801057d6 <alltraps>
...
801061d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061d6:	e9 fb f5 ff ff       	jmp    801057d6 <alltraps>
...
801061dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061e2:	e9 ef f5 ff ff       	jmp    801057d6 <alltraps>
...
801061e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061ee:	e9 e3 f5 ff ff       	jmp    801057d6 <alltraps>
...
801061f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061fa:	e9 d7 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106201:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106206:	e9 cb f5 ff ff       	jmp    801057d6 <alltraps>
...
8010620d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106212:	e9 bf f5 ff ff       	jmp    801057d6 <alltraps>
...
80106219:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010621e:	e9 b3 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106225:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010622a:	e9 a7 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106231:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106236:	e9 9b f5 ff ff       	jmp    801057d6 <alltraps>
...
8010623d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106242:	e9 8f f5 ff ff       	jmp    801057d6 <alltraps>
...
80106249:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010624e:	e9 83 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106255:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010625a:	e9 77 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106261:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106266:	e9 6b f5 ff ff       	jmp    801057d6 <alltraps>
...
8010626d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106272:	e9 5f f5 ff ff       	jmp    801057d6 <alltraps>
...
80106279:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010627e:	e9 53 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106285:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010628a:	e9 47 f5 ff ff       	jmp    801057d6 <alltraps>
...
80106291:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106296:	e9 3b f5 ff ff       	jmp    801057d6 <alltraps>
...
8010629d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801062a2:	e9 2f f5 ff ff       	jmp    801057d6 <alltraps>
...
801062a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801062ae:	e9 23 f5 ff ff       	jmp    801057d6 <alltraps>
...
801062b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062ba:	e9 17 f5 ff ff       	jmp    801057d6 <alltraps>
...
801062c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062c6:	e9 0b f5 ff ff       	jmp    801057d6 <alltraps>
...
801062cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062d2:	e9 ff f4 ff ff       	jmp    801057d6 <alltraps>
...
801062d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062de:	e9 f3 f4 ff ff       	jmp    801057d6 <alltraps>
...
801062e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062ea:	e9 e7 f4 ff ff       	jmp    801057d6 <alltraps>
...
801062f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062f6:	e9 db f4 ff ff       	jmp    801057d6 <alltraps>
...
801062fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106302:	e9 cf f4 ff ff       	jmp    801057d6 <alltraps>
...
80106309:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010630e:	e9 c3 f4 ff ff       	jmp    801057d6 <alltraps>
...
80106315:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010631a:	e9 b7 f4 ff ff       	jmp    801057d6 <alltraps>
...
80106321:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106326:	e9 ab f4 ff ff       	jmp    801057d6 <alltraps>
...
8010632d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106332:	e9 9f f4 ff ff       	jmp    801057d6 <alltraps>
...
80106339:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010633e:	e9 93 f4 ff ff       	jmp    801057d6 <alltraps>
...
80106345:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010634a:	e9 87 f4 ff ff       	jmp    801057d6 <alltraps>
...
80106351:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106356:	e9 7b f4 ff ff       	jmp    801057d6 <alltraps>
...
8010635d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106362:	e9 6f f4 ff ff       	jmp    801057d6 <alltraps>
...
80106369:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010636e:	e9 63 f4 ff ff       	jmp    801057d6 <alltraps>
...
80106375:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010637a:	e9 57 f4 ff ff       	jmp    801057d6 <alltraps>
...
80106381:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106386:	e9 4b f4 ff ff       	jmp    801057d6 <alltraps>
...
8010638d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106392:	e9 3f f4 ff ff       	jmp    801057d6 <alltraps>
...
80106399:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010639e:	e9 33 f4 ff ff       	jmp    801057d6 <alltraps>
...
801063a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801063aa:	e9 27 f4 ff ff       	jmp    801057d6 <alltraps>
...
801063b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063b6:	e9 1b f4 ff ff       	jmp    801057d6 <alltraps>
...
801063bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063c2:	e9 0f f4 ff ff       	jmp    801057d6 <alltraps>
...
801063c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063ce:	e9 03 f4 ff ff       	jmp    801057d6 <alltraps>
...
801063d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063da:	e9 f7 f3 ff ff       	jmp    801057d6 <alltraps>
...
801063e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063e6:	e9 eb f3 ff ff       	jmp    801057d6 <alltraps>
...
801063ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063f2:	e9 df f3 ff ff       	jmp    801057d6 <alltraps>
...
801063f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063fe:	e9 d3 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106405:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010640a:	e9 c7 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106411:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106416:	e9 bb f3 ff ff       	jmp    801057d6 <alltraps>
...
8010641d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106422:	e9 af f3 ff ff       	jmp    801057d6 <alltraps>
...
80106429:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010642e:	e9 a3 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106435:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010643a:	e9 97 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106441:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106446:	e9 8b f3 ff ff       	jmp    801057d6 <alltraps>
...
8010644d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106452:	e9 7f f3 ff ff       	jmp    801057d6 <alltraps>
...
80106459:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010645e:	e9 73 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106465:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010646a:	e9 67 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106471:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106476:	e9 5b f3 ff ff       	jmp    801057d6 <alltraps>
...
8010647d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106482:	e9 4f f3 ff ff       	jmp    801057d6 <alltraps>
...
80106489:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010648e:	e9 43 f3 ff ff       	jmp    801057d6 <alltraps>
...
80106495:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010649a:	e9 37 f3 ff ff       	jmp    801057d6 <alltraps>
...
801064a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801064a6:	e9 2b f3 ff ff       	jmp    801057d6 <alltraps>
...
801064ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064b2:	e9 1f f3 ff ff       	jmp    801057d6 <alltraps>
...
801064b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064be:	e9 13 f3 ff ff       	jmp    801057d6 <alltraps>
...
801064c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064ca:	e9 07 f3 ff ff       	jmp    801057d6 <alltraps>
...
801064d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064d6:	e9 fb f2 ff ff       	jmp    801057d6 <alltraps>
...
801064dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064e2:	e9 ef f2 ff ff       	jmp    801057d6 <alltraps>
...
801064e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064ee:	e9 e3 f2 ff ff       	jmp    801057d6 <alltraps>
...
801064f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064fa:	e9 d7 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106501:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106506:	e9 cb f2 ff ff       	jmp    801057d6 <alltraps>
...
8010650d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106512:	e9 bf f2 ff ff       	jmp    801057d6 <alltraps>
...
80106519:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010651e:	e9 b3 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106525:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010652a:	e9 a7 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106531:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106536:	e9 9b f2 ff ff       	jmp    801057d6 <alltraps>
...
8010653d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106542:	e9 8f f2 ff ff       	jmp    801057d6 <alltraps>
...
80106549:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010654e:	e9 83 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106555:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010655a:	e9 77 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106561:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106566:	e9 6b f2 ff ff       	jmp    801057d6 <alltraps>
...
8010656d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106572:	e9 5f f2 ff ff       	jmp    801057d6 <alltraps>
...
80106579:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010657e:	e9 53 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106585:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010658a:	e9 47 f2 ff ff       	jmp    801057d6 <alltraps>
...
80106591:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106596:	e9 3b f2 ff ff       	jmp    801057d6 <alltraps>
...
8010659d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801065a2:	e9 2f f2 ff ff       	jmp    801057d6 <alltraps>
...
801065a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801065ae:	e9 23 f2 ff ff       	jmp    801057d6 <alltraps>
...
801065b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065ba:	e9 17 f2 ff ff       	jmp    801057d6 <alltraps>
...
801065c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065c6:	e9 0b f2 ff ff       	jmp    801057d6 <alltraps>
...
801065cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065d2:	e9 ff f1 ff ff       	jmp    801057d6 <alltraps>
...
801065d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065de:	e9 f3 f1 ff ff       	jmp    801057d6 <alltraps>
...
801065e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065ea:	e9 e7 f1 ff ff       	jmp    801057d6 <alltraps>
...
801065f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065f6:	e9 db f1 ff ff       	jmp    801057d6 <alltraps>
...
801065fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106602:	e9 cf f1 ff ff       	jmp    801057d6 <alltraps>
...
80106609:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010660e:	e9 c3 f1 ff ff       	jmp    801057d6 <alltraps>
...
80106615:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010661a:	e9 b7 f1 ff ff       	jmp    801057d6 <alltraps>
...
80106621:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106626:	e9 ab f1 ff ff       	jmp    801057d6 <alltraps>
...
8010662d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106632:	e9 9f f1 ff ff       	jmp    801057d6 <alltraps>
...
80106639:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010663e:	e9 93 f1 ff ff       	jmp    801057d6 <alltraps>
...
80106645:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010664a:	e9 87 f1 ff ff       	jmp    801057d6 <alltraps>
...
80106651:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106656:	e9 7b f1 ff ff       	jmp    801057d6 <alltraps>
...
8010665d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106662:	e9 6f f1 ff ff       	jmp    801057d6 <alltraps>
...
80106669:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010666e:	e9 63 f1 ff ff       	jmp    801057d6 <alltraps>
...
80106675:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010667a:	e9 57 f1 ff ff       	jmp    801057d6 <alltraps>
...
80106681:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106686:	e9 4b f1 ff ff       	jmp    801057d6 <alltraps>
...
8010668d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106692:	e9 3f f1 ff ff       	jmp    801057d6 <alltraps>
...
80106699:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010669e:	e9 33 f1 ff ff       	jmp    801057d6 <alltraps>
...
801066a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801066aa:	e9 27 f1 ff ff       	jmp    801057d6 <alltraps>
...
801066b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066b6:	e9 1b f1 ff ff       	jmp    801057d6 <alltraps>
...
801066bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066c2:	e9 0f f1 ff ff       	jmp    801057d6 <alltraps>
...
801066c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066ce:	e9 03 f1 ff ff       	jmp    801057d6 <alltraps>
...
801066d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066da:	e9 f7 f0 ff ff       	jmp    801057d6 <alltraps>
...
801066e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066e6:	e9 eb f0 ff ff       	jmp    801057d6 <alltraps>
...
801066ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066f2:	e9 df f0 ff ff       	jmp    801057d6 <alltraps>
...
801066f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066fe:	e9 d3 f0 ff ff       	jmp    801057d6 <alltraps>
...
80106705:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010670a:	e9 c7 f0 ff ff       	jmp    801057d6 <alltraps>
...
80106711:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106716:	e9 bb f0 ff ff       	jmp    801057d6 <alltraps>
...
8010671d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106722:	e9 af f0 ff ff       	jmp    801057d6 <alltraps>
...
80106774:	e8 57 bd ff ff       	call   801024d0 <kalloc>
...
8010682d:	68 4c 7b 10 80       	push   $0x80107b4c
...
80106884:	e8 97 ba ff ff       	call   80102320 <kfree>
      *pte = 0;
...
801068d2:	68 a6 74 10 80       	push   $0x801074a6
...
801068e3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801068e6:	e8 a5 ce ff ff       	call   80103790 <cpuid>
...
801068fa:	c7 80 b8 31 11 80 ff 	movl   $0xffff,-0x7feece48(%eax)
80106901:	ff 00 00 
80106904:	c7 80 bc 31 11 80 00 	movl   $0xcf9a00,-0x7feece44(%eax)
8010690b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010690e:	c7 80 c0 31 11 80 ff 	movl   $0xffff,-0x7feece40(%eax)
80106915:	ff 00 00 
80106918:	c7 80 c4 31 11 80 00 	movl   $0xcf9200,-0x7feece3c(%eax)
8010691f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106922:	c7 80 c8 31 11 80 ff 	movl   $0xffff,-0x7feece38(%eax)
80106929:	ff 00 00 
8010692c:	c7 80 cc 31 11 80 00 	movl   $0xcffa00,-0x7feece34(%eax)
80106933:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106936:	c7 80 d0 31 11 80 ff 	movl   $0xffff,-0x7feece30(%eax)
8010693d:	ff 00 00 
80106940:	c7 80 d4 31 11 80 00 	movl   $0xcff200,-0x7feece2c(%eax)
80106947:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010694a:	05 b0 31 11 80       	add    $0x801131b0,%eax
  pd[1] = (uint)p;
...
80106970:	a1 84 5a 11 80       	mov    0x80115a84,%eax
{
...
80106abb:	77 49                	ja     80106b06 <inituvm+0x66>
  mem = kalloc();
80106abd:	e8 0e ba ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b09:	68 91 7b 10 80       	push   $0x80107b91
...
80106c2b:	e8 80 d9 ff ff       	call   801045b0 <memset>
...
80106c59:	0f 86 81 00 00 00    	jbe    80106ce0 <allocuvm+0x100>
    mem = kalloc();
80106c5f:	e8 6c b8 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106c6d:	68 c9 7b 10 80       	push   $0x80107bc9
...
80106ca3:	68 e1 7b 10 80       	push   $0x80107be1
...
80106ccb:	e8 50 b6 ff ff       	call   80102320 <kfree>
      return 0;
...
80106dac:	68 fd 7b 10 80       	push   $0x80107bfd
...
80106dc5:	e8 06 b7 ff ff       	call   801024d0 <kalloc>
...
80106de0:	e8 cb d7 ff ff       	call   801045b0 <memset>
...
80106e4b:	a3 84 5a 11 80       	mov    %eax,0x80115a84
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e7f:	68 0e 7c 10 80       	push   $0x80107c0e
...
80106ed0:	e8 8b d7 ff ff       	call   80104660 <memmove>
...
80106f25:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106f28:	e8 a3 b5 ff ff       	call   801024d0 <kalloc>
...
80106fff:	e8 5c d6 ff ff       	call   80104660 <memmove>
    len -= n;
    buf += n;
...
80107061:	b8 c4 a5 10 80       	mov    $0x8010a5c4,%eax
80107066:	b9 7c af 10 80       	mov    $0x8010af7c,%ecx
8010706b:	89 e5                	mov    %esp,%ebp
8010706d:	8b 55 08             	mov    0x8(%ebp),%edx
    /* setting initial seeds to mt[N] using         */
    /* the generator Line 25 of Table 1 in          */
    /* [KNUTH 1981, The Art of Computer Programming */
    /*    Vol. 2 (2nd Ed.), pp102]                  */
    mt[0]= seed & 0xffffffff;
80107070:	89 15 c0 a5 10 80    	mov    %edx,0x8010a5c0
80107076:	eb 0b                	jmp    80107083 <sgenrand+0x23>
80107078:	90                   	nop
80107079:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107080:	83 c0 04             	add    $0x4,%eax
    for (mti=1; mti<N; mti++)
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
80107083:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
80107089:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010708b:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
8010708d:	75 f1                	jne    80107080 <sgenrand+0x20>
8010708f:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
80107096:	02 00 00 
}
80107099:	5d                   	pop    %ebp
8010709a:	c3                   	ret    
...
801070a0:	a1 60 a4 10 80       	mov    0x8010a460,%eax
{
...
801070a9:	53                   	push   %ebx
    if (mti >= N) { /* generate N words at one time */
801070aa:	3d 6f 02 00 00       	cmp    $0x26f,%eax
801070af:	0f 8e f9 00 00 00    	jle    801071ae <genrand+0x10e>
        int kk;

        if (mti == N+1)   /* if sgenrand() has not been called, */
801070b5:	3d 71 02 00 00       	cmp    $0x271,%eax
801070ba:	0f 84 fa 00 00 00    	je     801071ba <genrand+0x11a>
801070c0:	ba c0 a5 10 80       	mov    $0x8010a5c0,%edx
801070c5:	bb 4c a9 10 80       	mov    $0x8010a94c,%ebx
    mt[0]= seed & 0xffffffff;
801070ca:	89 d1                	mov    %edx,%ecx
801070cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            sgenrand(4357); /* a default initial seed is used   */

        for (kk=0;kk<N-M;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
801070d0:	8b 01                	mov    (%ecx),%eax
801070d2:	8b 71 04             	mov    0x4(%ecx),%esi
801070d5:	83 c1 04             	add    $0x4,%ecx
801070d8:	81 e6 ff ff ff 7f    	and    $0x7fffffff,%esi
801070de:	25 00 00 00 80       	and    $0x80000000,%eax
801070e3:	09 f0                	or     %esi,%eax
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
801070e5:	89 c6                	mov    %eax,%esi
801070e7:	83 e0 01             	and    $0x1,%eax
801070ea:	d1 ee                	shr    %esi
801070ec:	33 b1 30 06 00 00    	xor    0x630(%ecx),%esi
801070f2:	33 34 85 70 7c 10 80 	xor    -0x7fef8390(,%eax,4),%esi
801070f9:	89 71 fc             	mov    %esi,-0x4(%ecx)
        for (kk=0;kk<N-M;kk++) {
801070fc:	39 cb                	cmp    %ecx,%ebx
801070fe:	75 d0                	jne    801070d0 <genrand+0x30>
80107100:	b9 f0 ab 10 80       	mov    $0x8010abf0,%ecx
80107105:	8d 76 00             	lea    0x0(%esi),%esi
        }
        for (;kk<N-1;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107108:	8b 82 8c 03 00 00    	mov    0x38c(%edx),%eax
8010710e:	8b 9a 90 03 00 00    	mov    0x390(%edx),%ebx
80107114:	83 c2 04             	add    $0x4,%edx
80107117:	81 e3 ff ff ff 7f    	and    $0x7fffffff,%ebx
8010711d:	25 00 00 00 80       	and    $0x80000000,%eax
80107122:	09 d8                	or     %ebx,%eax
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
80107124:	89 c3                	mov    %eax,%ebx
80107126:	83 e0 01             	and    $0x1,%eax
80107129:	d1 eb                	shr    %ebx
8010712b:	33 5a fc             	xor    -0x4(%edx),%ebx
8010712e:	33 1c 85 70 7c 10 80 	xor    -0x7fef8390(,%eax,4),%ebx
80107135:	89 9a 88 03 00 00    	mov    %ebx,0x388(%edx)
        for (;kk<N-1;kk++) {
8010713b:	39 d1                	cmp    %edx,%ecx
8010713d:	75 c9                	jne    80107108 <genrand+0x68>
        }
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
8010713f:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
80107144:	8b 0d 7c af 10 80    	mov    0x8010af7c,%ecx
8010714a:	89 c2                	mov    %eax,%edx
8010714c:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80107152:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80107158:	09 d1                	or     %edx,%ecx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
8010715a:	89 ca                	mov    %ecx,%edx
8010715c:	83 e1 01             	and    $0x1,%ecx
8010715f:	d1 ea                	shr    %edx
80107161:	33 15 f0 ab 10 80    	xor    0x8010abf0,%edx
80107167:	33 14 8d 70 7c 10 80 	xor    -0x7fef8390(,%ecx,4),%edx
8010716e:	89 15 7c af 10 80    	mov    %edx,0x8010af7c
80107174:	ba 01 00 00 00       	mov    $0x1,%edx

        mti = 0;
    }

    y = mt[mti++];
80107179:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
8010717f:	89 c2                	mov    %eax,%edx
80107181:	c1 ea 0b             	shr    $0xb,%edx
80107184:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
80107186:	89 d0                	mov    %edx,%eax
80107188:	c1 e0 07             	shl    $0x7,%eax
8010718b:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
80107190:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
80107192:	89 d0                	mov    %edx,%eax
80107194:	c1 e0 0f             	shl    $0xf,%eax
80107197:	25 00 00 c6 ef       	and    $0xefc60000,%eax
8010719c:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_L(y);
8010719e:	89 c2                	mov    %eax,%edx
801071a0:	c1 ea 12             	shr    $0x12,%edx
801071a3:	31 d0                	xor    %edx,%eax
...
801071a5:	5b                   	pop    %ebx
    return y & RAND_MAX;
801071a6:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
801071ab:	5e                   	pop    %esi
801071ac:	5d                   	pop    %ebp
801071ad:	c3                   	ret    
801071ae:	8d 50 01             	lea    0x1(%eax),%edx
801071b1:	8b 04 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%eax
801071b8:	eb bf                	jmp    80107179 <genrand+0xd9>
    mt[0]= seed & 0xffffffff;
801071ba:	c7 05 c0 a5 10 80 05 	movl   $0x1105,0x8010a5c0
801071c1:	11 00 00 
801071c4:	b8 c4 a5 10 80       	mov    $0x8010a5c4,%eax
801071c9:	b9 7c af 10 80       	mov    $0x8010af7c,%ecx
801071ce:	ba 05 11 00 00       	mov    $0x1105,%edx
801071d3:	eb 06                	jmp    801071db <genrand+0x13b>
801071d5:	8d 76 00             	lea    0x0(%esi),%esi
801071d8:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801071db:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
801071e1:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801071e3:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801071e5:	75 f1                	jne    801071d8 <genrand+0x138>
801071e7:	e9 d4 fe ff ff       	jmp    801070c0 <genrand+0x20>
801071ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801071f0 <random_at_most>:
...
801071f1:	31 d2                	xor    %edx,%edx
long random_at_most(long max) {
801071f3:	89 e5                	mov    %esp,%ebp
801071f5:	56                   	push   %esi
801071f6:	53                   	push   %ebx
            num_bins = (unsigned long) max + 1,
801071f7:	8b 45 08             	mov    0x8(%ebp),%eax
            bin_size = num_rand / num_bins,
801071fa:	bb 00 00 00 80       	mov    $0x80000000,%ebx
            num_bins = (unsigned long) max + 1,
801071ff:	8d 48 01             	lea    0x1(%eax),%ecx
            bin_size = num_rand / num_bins,
80107202:	89 d8                	mov    %ebx,%eax
80107204:	f7 f1                	div    %ecx
80107206:	89 c6                	mov    %eax,%esi
80107208:	29 d3                	sub    %edx,%ebx
8010720a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    do {
        x = genrand();
80107210:	e8 8b fe ff ff       	call   801070a0 <genrand>
    }
        // This is carefully written not to overflow
    while (num_rand - defect <= (unsigned long)x);
80107215:	39 d8                	cmp    %ebx,%eax
80107217:	73 f7                	jae    80107210 <random_at_most+0x20>

    // Truncated division is intentional
    return x/bin_size;
80107219:	31 d2                	xor    %edx,%edx
8010721b:	f7 f6                	div    %esi
8010721d:	5b                   	pop    %ebx
8010721e:	5e                   	pop    %esi
8010721f:	5d                   	pop    %ebp
80107220:	c3                   	ret    
