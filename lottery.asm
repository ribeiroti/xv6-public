...
void process_test(int id, int tickets){
    ...
    if (fork(tickets)) {
  11:	6a 0a                	push   $0xa
  13:	e8 92 02 00 00       	call   2aa <fork>
  18:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  1f:	e8 86 02 00 00       	call   2aa <fork>
  24:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
  2b:	e8 7a 02 00 00       	call   2aa <fork>
  30:	c7 04 24 88 13 00 00 	movl   $0x1388,(%esp)
  37:	e8 6e 02 00 00       	call   2aa <fork>
    exit();
  3c:	e8 71 02 00 00       	call   2b2 <exit>
  41:	66 90                	xchg   %ax,%ax
  43:	66 90                	xchg   %ax,%ax
  45:	66 90                	xchg   %ax,%ax
  47:	66 90                	xchg   %ax,%ax
...
//            if ((i % 50) == 0) printf(1, "ID: %d | TICKETS: %d\n", id, tickets);
  ...
  59:	5d                   	pop    %ebp
    if (fork(tickets)) {
  5a:	e9 4b 02 00 00       	jmp    2aa <fork>
  5f:	90                   	nop
...
free(void *ap)
{
 ...
 5d1:	a1 24 0a 00 00       	mov    0xa24,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 24 0a 00 00       	mov    %eax,0xa24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 24 0a 00 00    	mov    0xa24,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 24 0a 00 00    	mov    %edx,0xa24
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 24 0a 00 00 28 	movl   $0xa28,0xa24
 727:	0a 00 00 
 72a:	c7 05 28 0a 00 00 28 	movl   $0xa28,0xa28
 731:	0a 00 00 
    base.s.size = 0;
 734:	b8 28 0a 00 00       	mov    $0xa28,%eax
 739:	c7 05 2c 0a 00 00 00 	movl   $0x0,0xa2c
 740:	00 00 00 
