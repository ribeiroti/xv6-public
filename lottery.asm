...
void process_test(int id, int tickets){
  ...
  16:	83 ec 0c             	sub    $0xc,%esp
        process_test(i, i*i*100);
  19:	0f af c3             	imul   %ebx,%eax
  1c:	6b c0 64             	imul   $0x64,%eax,%eax
    if (fork(tickets)) {
  1f:	50                   	push   %eax
  20:	e8 95 02 00 00       	call   2ba <fork>
  25:	83 c4 10             	add    $0x10,%esp
  28:	85 c0                	test   %eax,%eax
  2a:	75 0d                	jne    39 <main+0x39>
    for (int i = 1; i <= QTD_PROC; i++) {
  2c:	83 c3 01             	add    $0x1,%ebx
  2f:	83 fb 06             	cmp    $0x6,%ebx
  32:	75 e0                	jne    14 <main+0x14>
    exit();
  34:	e8 89 02 00 00       	call   2c2 <exit>
  39:	eb fe                	jmp    39 <main+0x39>
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop

00000040 <process_test>:
void process_test(int id, int tickets){
  40:	55                   	push   %ebp
  41:	89 e5                	mov    %esp,%ebp
  43:	83 ec 14             	sub    $0x14,%esp
    if (fork(tickets)) {
  46:	ff 75 0c             	pushl  0xc(%ebp)
  49:	e8 6c 02 00 00       	call   2ba <fork>
  4e:	83 c4 10             	add    $0x10,%esp
  51:	85 c0                	test   %eax,%eax
  53:	74 0b                	je     60 <process_test+0x20>
  55:	eb fe                	jmp    55 <process_test+0x15>
